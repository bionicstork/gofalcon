...
func (m *RegistrationScanScheduleResponseV1) validateErrors(formats strfmt.Registry) error {
...
func (m *RegistrationScanScheduleResponseV1) validateMeta(formats strfmt.Registry) error {
...
func (m *RegistrationScanScheduleResponseV1) validateResources(formats strfmt.Registry) error {
...
func (m *RegistrationScanScheduleResponseV1) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RegistrationScanScheduleResponseV1) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RegistrationScanScheduleResponseV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RegistrationScanScheduleResponseV1) UnmarshalBinary(b []byte) error {
	var res RegistrationScanScheduleResponseV1
