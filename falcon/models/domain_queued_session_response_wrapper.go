...
func (m *DomainQueuedSessionResponseWrapper) validateErrors(formats strfmt.Registry) error {
...
func (m *DomainQueuedSessionResponseWrapper) validateMeta(formats strfmt.Registry) error {
...
func (m *DomainQueuedSessionResponseWrapper) validateResources(formats strfmt.Registry) error {
...
func (m *DomainQueuedSessionResponseWrapper) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainQueuedSessionResponseWrapper) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainQueuedSessionResponseWrapper) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainQueuedSessionResponseWrapper) UnmarshalBinary(b []byte) error {
	var res DomainQueuedSessionResponseWrapper
