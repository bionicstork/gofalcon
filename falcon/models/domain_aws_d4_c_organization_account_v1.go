...
// DomainAWSD4COrganizationAccountV1 domain AWS d4 c organization account v1
//
...
// Validate validates this domain AWS d4 c organization account v1
func (m *DomainAWSD4COrganizationAccountV1) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this domain AWS d4 c organization account v1 based on context it is used
