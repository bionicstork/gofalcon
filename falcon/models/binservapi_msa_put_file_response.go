...
func (m *BinservapiMsaPutFileResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *BinservapiMsaPutFileResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *BinservapiMsaPutFileResponse) validateResources(formats strfmt.Registry) error {
...
func (m *BinservapiMsaPutFileResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BinservapiMsaPutFileResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BinservapiMsaPutFileResponse) UnmarshalBinary(b []byte) error {
	var res BinservapiMsaPutFileResponse
