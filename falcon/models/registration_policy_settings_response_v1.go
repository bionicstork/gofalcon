...
func (m *RegistrationPolicySettingsResponseV1) validateErrors(formats strfmt.Registry) error {
...
func (m *RegistrationPolicySettingsResponseV1) validateMeta(formats strfmt.Registry) error {
...
func (m *RegistrationPolicySettingsResponseV1) validateResources(formats strfmt.Registry) error {
...
func (m *RegistrationPolicySettingsResponseV1) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RegistrationPolicySettingsResponseV1) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RegistrationPolicySettingsResponseV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RegistrationPolicySettingsResponseV1) UnmarshalBinary(b []byte) error {
	var res RegistrationPolicySettingsResponseV1
