...
func (m *RequestsCreateSensorUpdatePoliciesV1) validateResources(formats strfmt.Registry) error {
...
func (m *RequestsCreateSensorUpdatePoliciesV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RequestsCreateSensorUpdatePoliciesV1) UnmarshalBinary(b []byte) error {
	var res RequestsCreateSensorUpdatePoliciesV1
