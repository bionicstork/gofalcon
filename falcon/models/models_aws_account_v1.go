...
// ModelsAWSAccountV1 models AWS account v1
//
...
// Validate validates this models AWS account v1
...
// ContextValidate validate this models AWS account v1 based on the context it is used
