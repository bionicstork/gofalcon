...
// DomainSPAPIQueryPaging domain SPAPI query paging
//
...
// Validate validates this domain SPAPI query paging
...
// ContextValidate validates this domain SPAPI query paging based on context it is used
