...
func (m *MsaReplyAffectedEntities) validateErrors(formats strfmt.Registry) error {
...
func (m *MsaReplyAffectedEntities) validateMeta(formats strfmt.Registry) error {
...
func (m *MsaReplyAffectedEntities) validateResources(formats strfmt.Registry) error {
...
func (m *MsaReplyAffectedEntities) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MsaReplyAffectedEntities) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MsaReplyAffectedEntities) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MsaReplyAffectedEntities) UnmarshalBinary(b []byte) error {
	var res MsaReplyAffectedEntities
