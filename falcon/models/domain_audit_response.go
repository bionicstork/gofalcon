...
func (m *DomainAuditResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *DomainAuditResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *DomainAuditResponse) validateResources(formats strfmt.Registry) error {
...
func (m *DomainAuditResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainAuditResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainAuditResponse) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
