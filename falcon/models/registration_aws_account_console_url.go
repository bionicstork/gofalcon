...
// RegistrationAWSAccountConsoleURL registration AWS account console URL
//
...
// Validate validates this registration AWS account console URL
func (m *RegistrationAWSAccountConsoleURL) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this registration AWS account console URL based on context it is used
