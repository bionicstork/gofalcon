...
func (m *MainDiscoveryResponseV2) validateErrors(formats strfmt.Registry) error {
...
func (m *MainDiscoveryResponseV2) validateMeta(formats strfmt.Registry) error {
...
func (m *MainDiscoveryResponseV2) validateResources(formats strfmt.Registry) error {
...
func (m *MainDiscoveryResponseV2) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MainDiscoveryResponseV2) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MainDiscoveryResponseV2) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MainDiscoveryResponseV2) UnmarshalBinary(b []byte) error {
	var res MainDiscoveryResponseV2
