...
func (m *K8sregGetLocationsResp) validateErrors(formats strfmt.Registry) error {
...
func (m *K8sregGetLocationsResp) validateMeta(formats strfmt.Registry) error {
...
func (m *K8sregGetLocationsResp) validateResources(formats strfmt.Registry) error {
...
func (m *K8sregGetLocationsResp) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8sregGetLocationsResp) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8sregGetLocationsResp) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8sregGetLocationsResp) UnmarshalBinary(b []byte) error {
	var res K8sregGetLocationsResp
