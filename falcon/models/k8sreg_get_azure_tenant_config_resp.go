...
func (m *K8sregGetAzureTenantConfigResp) validateErrors(formats strfmt.Registry) error {
...
func (m *K8sregGetAzureTenantConfigResp) validateMeta(formats strfmt.Registry) error {
...
func (m *K8sregGetAzureTenantConfigResp) validateResources(formats strfmt.Registry) error {
...
func (m *K8sregGetAzureTenantConfigResp) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8sregGetAzureTenantConfigResp) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8sregGetAzureTenantConfigResp) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8sregGetAzureTenantConfigResp) UnmarshalBinary(b []byte) error {
	var res K8sregGetAzureTenantConfigResp
