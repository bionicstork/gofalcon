...
func (m *DomainExternalQueryResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *DomainExternalQueryResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *DomainExternalQueryResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainExternalQueryResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainExternalQueryResponse) UnmarshalBinary(b []byte) error {
	var res DomainExternalQueryResponse
