...
// K8sregCreateAWSAccReq k8sreg create AWS acc req
//
...
// Validate validates this k8sreg create AWS acc req
...
// ContextValidate validate this k8sreg create AWS acc req based on the context it is used
