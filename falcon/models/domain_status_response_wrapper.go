...
func (m *DomainStatusResponseWrapper) validateErrors(formats strfmt.Registry) error {
...
func (m *DomainStatusResponseWrapper) validateMeta(formats strfmt.Registry) error {
...
func (m *DomainStatusResponseWrapper) validateResources(formats strfmt.Registry) error {
...
func (m *DomainStatusResponseWrapper) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainStatusResponseWrapper) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainStatusResponseWrapper) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainStatusResponseWrapper) UnmarshalBinary(b []byte) error {
	var res DomainStatusResponseWrapper
