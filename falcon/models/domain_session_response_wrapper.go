...
func (m *DomainSessionResponseWrapper) validateErrors(formats strfmt.Registry) error {
...
func (m *DomainSessionResponseWrapper) validateMeta(formats strfmt.Registry) error {
...
func (m *DomainSessionResponseWrapper) validateResources(formats strfmt.Registry) error {
...
func (m *DomainSessionResponseWrapper) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainSessionResponseWrapper) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainSessionResponseWrapper) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainSessionResponseWrapper) UnmarshalBinary(b []byte) error {
	var res DomainSessionResponseWrapper
