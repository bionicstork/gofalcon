...
// RegistrationExternalIOAEventResponse registration external IOA event response
//
...
// Validate validates this registration external IOA event response
...
// ContextValidate validate this registration external IOA event response based on the context it is used
