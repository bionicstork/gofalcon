...
func (m *APIMsaReplyDevicesRanOn) validateErrors(formats strfmt.Registry) error {
...
func (m *APIMsaReplyDevicesRanOn) validateMeta(formats strfmt.Registry) error {
...
func (m *APIMsaReplyDevicesRanOn) validateResources(formats strfmt.Registry) error {
...
func (m *APIMsaReplyDevicesRanOn) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APIMsaReplyDevicesRanOn) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APIMsaReplyDevicesRanOn) UnmarshalBinary(b []byte) error {
	var res APIMsaReplyDevicesRanOn
