...
func (m *RegistrationStaticScriptsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RegistrationStaticScriptsResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *RegistrationStaticScriptsResponse) validateResources(formats strfmt.Registry) error {
...
func (m *RegistrationStaticScriptsResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RegistrationStaticScriptsResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RegistrationStaticScriptsResponse) UnmarshalBinary(b []byte) error {
	var res RegistrationStaticScriptsResponse
