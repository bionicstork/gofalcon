...
// DomainCIDPolicyAssignments domain CID policy assignments
//
...
// Validate validates this domain CID policy assignments
...
// ContextValidate validate this domain CID policy assignments based on the context it is used
