...
func (m *MlscannerapiQueryResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *MlscannerapiQueryResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *MlscannerapiQueryResponse) validateResources(formats strfmt.Registry) error {
...
func (m *MlscannerapiQueryResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MlscannerapiQueryResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MlscannerapiQueryResponse) UnmarshalBinary(b []byte) error {
	var res MlscannerapiQueryResponse
