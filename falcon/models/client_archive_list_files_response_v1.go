...
func (m *ClientArchiveListFilesResponseV1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ClientArchiveListFilesResponseV1) validateErrors(formats strfmt.Registry) error {
...
func (m *ClientArchiveListFilesResponseV1) validateMeta(formats strfmt.Registry) error {
...
func (m *ClientArchiveListFilesResponseV1) validateResources(formats strfmt.Registry) error {
...
func (m *ClientArchiveListFilesResponseV1) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ClientArchiveListFilesResponseV1) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ClientArchiveListFilesResponseV1) UnmarshalBinary(b []byte) error {
	var res ClientArchiveListFilesResponseV1
