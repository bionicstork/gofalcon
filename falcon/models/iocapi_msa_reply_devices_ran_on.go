...
func (m *IocapiMsaReplyDevicesRanOn) validateErrors(formats strfmt.Registry) error {
...
func (m *IocapiMsaReplyDevicesRanOn) validateMeta(formats strfmt.Registry) error {
...
func (m *IocapiMsaReplyDevicesRanOn) validateResources(formats strfmt.Registry) error {
...
func (m *IocapiMsaReplyDevicesRanOn) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IocapiMsaReplyDevicesRanOn) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IocapiMsaReplyDevicesRanOn) UnmarshalBinary(b []byte) error {
	var res IocapiMsaReplyDevicesRanOn
