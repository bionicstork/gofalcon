...
// DomainCIDGroupMembersRequestV1 domain CID group members request v1
//
...
// Validate validates this domain CID group members request v1
...
// ContextValidate validate this domain CID group members request v1 based on the context it is used
