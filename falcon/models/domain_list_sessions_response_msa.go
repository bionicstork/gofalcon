...
func (m *DomainListSessionsResponseMsa) validateErrors(formats strfmt.Registry) error {
...
func (m *DomainListSessionsResponseMsa) validateMeta(formats strfmt.Registry) error {
...
func (m *DomainListSessionsResponseMsa) validateResources(formats strfmt.Registry) error {
...
func (m *DomainListSessionsResponseMsa) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainListSessionsResponseMsa) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainListSessionsResponseMsa) UnmarshalBinary(b []byte) error {
	var res DomainListSessionsResponseMsa
