...
// DomainSPAPIQueryResponse domain SPAPI query response
//
...
// Validate validates this domain SPAPI query response
...
// ContextValidate validate this domain SPAPI query response based on the context it is used
