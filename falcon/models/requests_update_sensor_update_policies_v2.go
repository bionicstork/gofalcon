...
func (m *RequestsUpdateSensorUpdatePoliciesV2) validateResources(formats strfmt.Registry) error {
...
func (m *RequestsUpdateSensorUpdatePoliciesV2) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RequestsUpdateSensorUpdatePoliciesV2) UnmarshalBinary(b []byte) error {
	var res RequestsUpdateSensorUpdatePoliciesV2
