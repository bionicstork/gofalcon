...
func (m *DeviceapiDeviceResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *DeviceapiDeviceResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *DeviceapiDeviceResponse) validateResources(formats strfmt.Registry) error {
...
func (m *DeviceapiDeviceResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeviceapiDeviceResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeviceapiDeviceResponse) UnmarshalBinary(b []byte) error {
	var res DeviceapiDeviceResponse
