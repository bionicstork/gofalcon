...
// RegistrationAWSAccountResponseV2 registration AWS account response v2
//
...
// Validate validates this registration AWS account response v2
...
// ContextValidate validate this registration AWS account response v2 based on the context it is used
