...
func (m *RegistrationPolicyResponseV1) validateErrors(formats strfmt.Registry) error {
...
func (m *RegistrationPolicyResponseV1) validateMeta(formats strfmt.Registry) error {
...
func (m *RegistrationPolicyResponseV1) validateResources(formats strfmt.Registry) error {
...
func (m *RegistrationPolicyResponseV1) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RegistrationPolicyResponseV1) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RegistrationPolicyResponseV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RegistrationPolicyResponseV1) UnmarshalBinary(b []byte) error {
	var res RegistrationPolicyResponseV1
