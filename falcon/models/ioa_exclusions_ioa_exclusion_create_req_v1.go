...
func (m *IOAExclusionsIOAExclusionCreateReqV1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IOAExclusionsIOAExclusionCreateReqV1) validateClRegex(formats strfmt.Registry) error {
...
func (m *IOAExclusionsIOAExclusionCreateReqV1) validateGroups(formats strfmt.Registry) error {
...
func (m *IOAExclusionsIOAExclusionCreateReqV1) validateIfnRegex(formats strfmt.Registry) error {
...
func (m *IOAExclusionsIOAExclusionCreateReqV1) validateName(formats strfmt.Registry) error {
...
func (m *IOAExclusionsIOAExclusionCreateReqV1) validatePatternID(formats strfmt.Registry) error {
...
func (m *IOAExclusionsIOAExclusionCreateReqV1) validatePatternName(formats strfmt.Registry) error {
...
func (m *IOAExclusionsIOAExclusionCreateReqV1) UnmarshalBinary(b []byte) error {
	var res IOAExclusionsIOAExclusionCreateReqV1
