...
func (m *BinservclientMsaPutFileResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *BinservclientMsaPutFileResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *BinservclientMsaPutFileResponse) validateResources(formats strfmt.Registry) error {
...
func (m *BinservclientMsaPutFileResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BinservclientMsaPutFileResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BinservclientMsaPutFileResponse) UnmarshalBinary(b []byte) error {
	var res BinservclientMsaPutFileResponse
