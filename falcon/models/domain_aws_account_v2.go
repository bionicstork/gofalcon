...
// DomainAWSAccountV2 domain AWS account v2
//
...
// Validate validates this domain AWS account v2
...
// ContextValidate validate this domain AWS account v2 based on the context it is used
