...
func (m *ExternalGetChangesResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *ExternalGetChangesResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *ExternalGetChangesResponse) validateResources(formats strfmt.Registry) error {
...
func (m *ExternalGetChangesResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ExternalGetChangesResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ExternalGetChangesResponse) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ExternalGetChangesResponse) UnmarshalBinary(b []byte) error {
	var res ExternalGetChangesResponse
