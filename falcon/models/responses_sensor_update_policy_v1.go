...
func (m *ResponsesSensorUpdatePolicyV1) validateCreatedBy(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV1) validateCreatedTimestamp(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV1) validateDescription(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV1) validateEnabled(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV1) validateGroups(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV1) validateID(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV1) validateModifiedBy(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV1) validateModifiedTimestamp(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV1) validateName(formats strfmt.Registry) error {
...
var responsesSensorUpdatePolicyV1TypePlatformNamePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		responsesSensorUpdatePolicyV1TypePlatformNamePropEnum = append(responsesSensorUpdatePolicyV1TypePlatformNamePropEnum, v)
	}
}
...
// prop value enum
func (m *ResponsesSensorUpdatePolicyV1) validatePlatformNameEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, responsesSensorUpdatePolicyV1TypePlatformNamePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ResponsesSensorUpdatePolicyV1) validatePlatformName(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV1) validateSettings(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV1) contextValidateGroups(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV1) contextValidateSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV1) UnmarshalBinary(b []byte) error {
	var res ResponsesSensorUpdatePolicyV1
