...
func (m *RegistrationBaseResponseV1) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RegistrationBaseResponseV1) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
