...
func (m *ResponsesSensorUpdateBuildsV1) validateErrors(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdateBuildsV1) validateMeta(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdateBuildsV1) validateResources(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdateBuildsV1) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdateBuildsV1) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdateBuildsV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdateBuildsV1) UnmarshalBinary(b []byte) error {
	var res ResponsesSensorUpdateBuildsV1
