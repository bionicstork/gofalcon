...
// RegistrationAWSAccountD4CExtV2 registration AWS account d4 c ext v2
//
...
// Validate validates this registration AWS account d4 c ext v2
...
// ContextValidate validates this registration AWS account d4 c ext v2 based on context it is used
