...
func (m *K8sregGetScriptsResp) validateErrors(formats strfmt.Registry) error {
...
func (m *K8sregGetScriptsResp) validateMeta(formats strfmt.Registry) error {
...
func (m *K8sregGetScriptsResp) validateResources(formats strfmt.Registry) error {
...
func (m *K8sregGetScriptsResp) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8sregGetScriptsResp) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
