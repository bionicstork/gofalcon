...
// RegistrationIOAEvent registration IOA event
//
...
// Validate validates this registration IOA event
...
// ContextValidate validate this registration IOA event based on the context it is used
