...
func (m *K8sregGetAzureBashScriptResp) validateErrors(formats strfmt.Registry) error {
...
func (m *K8sregGetAzureBashScriptResp) validateMeta(formats strfmt.Registry) error {
...
func (m *K8sregGetAzureBashScriptResp) validateResources(formats strfmt.Registry) error {
...
func (m *K8sregGetAzureBashScriptResp) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8sregGetAzureBashScriptResp) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8sregGetAzureBashScriptResp) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8sregGetAzureBashScriptResp) UnmarshalBinary(b []byte) error {
	var res K8sregGetAzureBashScriptResp
