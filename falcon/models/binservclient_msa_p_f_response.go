...
func (m *BinservclientMsaPFResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *BinservclientMsaPFResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *BinservclientMsaPFResponse) validateResources(formats strfmt.Registry) error {
...
func (m *BinservclientMsaPFResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BinservclientMsaPFResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BinservclientMsaPFResponse) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BinservclientMsaPFResponse) UnmarshalBinary(b []byte) error {
	var res BinservclientMsaPFResponse
