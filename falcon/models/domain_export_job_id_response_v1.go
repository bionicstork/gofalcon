...
func (m *DomainExportJobIDResponseV1) validateErrors(formats strfmt.Registry) error {
...
func (m *DomainExportJobIDResponseV1) validateMeta(formats strfmt.Registry) error {
...
func (m *DomainExportJobIDResponseV1) validateResources(formats strfmt.Registry) error {
...
func (m *DomainExportJobIDResponseV1) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainExportJobIDResponseV1) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainExportJobIDResponseV1) UnmarshalBinary(b []byte) error {
	var res DomainExportJobIDResponseV1
