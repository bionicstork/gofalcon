...
func (m *PublicGetChangesResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *PublicGetChangesResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *PublicGetChangesResponse) validateResources(formats strfmt.Registry) error {
...
func (m *PublicGetChangesResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PublicGetChangesResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PublicGetChangesResponse) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PublicGetChangesResponse) UnmarshalBinary(b []byte) error {
	var res PublicGetChangesResponse
