...
func (m *RegistrationIOAUserResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *RegistrationIOAUserResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *RegistrationIOAUserResponse) validateResources(formats strfmt.Registry) error {
...
func (m *RegistrationIOAUserResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RegistrationIOAUserResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RegistrationIOAUserResponse) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RegistrationIOAUserResponse) UnmarshalBinary(b []byte) error {
	var res RegistrationIOAUserResponse
