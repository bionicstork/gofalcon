...
func (m *SchemaSensorEventResponseV1) validateErrors(formats strfmt.Registry) error {
...
func (m *SchemaSensorEventResponseV1) validateMeta(formats strfmt.Registry) error {
...
func (m *SchemaSensorEventResponseV1) validateResources(formats strfmt.Registry) error {
...
func (m *SchemaSensorEventResponseV1) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SchemaSensorEventResponseV1) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SchemaSensorEventResponseV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SchemaSensorEventResponseV1) UnmarshalBinary(b []byte) error {
	var res SchemaSensorEventResponseV1
