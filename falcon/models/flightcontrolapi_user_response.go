...
func (m *FlightcontrolapiUserResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *FlightcontrolapiUserResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *FlightcontrolapiUserResponse) validateResources(formats strfmt.Registry) error {
...
func (m *FlightcontrolapiUserResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FlightcontrolapiUserResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FlightcontrolapiUserResponse) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FlightcontrolapiUserResponse) UnmarshalBinary(b []byte) error {
	var res FlightcontrolapiUserResponse
