...
// ModelsAWSCustomerSettingsRequestV1 models AWS customer settings request v1
//
...
// Validate validates this models AWS customer settings request v1
func (m *ModelsAWSCustomerSettingsRequestV1) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this models AWS customer settings request v1 based on context it is used
