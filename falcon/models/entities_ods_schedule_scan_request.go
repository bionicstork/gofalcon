...
// EntitiesODSScheduleScanRequest entities ODS schedule scan request
//
...
// Validate validates this entities ODS schedule scan request
...
// ContextValidate validate this entities ODS schedule scan request based on the context it is used
