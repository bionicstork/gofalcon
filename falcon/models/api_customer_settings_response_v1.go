...
func (m *APICustomerSettingsResponseV1) validateErrors(formats strfmt.Registry) error {
...
func (m *APICustomerSettingsResponseV1) validateMeta(formats strfmt.Registry) error {
...
func (m *APICustomerSettingsResponseV1) validateResources(formats strfmt.Registry) error {
...
func (m *APICustomerSettingsResponseV1) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APICustomerSettingsResponseV1) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APICustomerSettingsResponseV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APICustomerSettingsResponseV1) UnmarshalBinary(b []byte) error {
	var res APICustomerSettingsResponseV1
