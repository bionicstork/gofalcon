...
// DomainAWSD4CAccountV1 domain AWS d4 c account v1
//
...
// Validate validates this domain AWS d4 c account v1
...
// ContextValidate validate this domain AWS d4 c account v1 based on the context it is used
