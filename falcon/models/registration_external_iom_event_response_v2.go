...
// RegistrationExternalIOMEventResponseV2 registration external IOM event response v2
//
...
// Validate validates this registration external IOM event response v2
...
// ContextValidate validate this registration external IOM event response v2 based on the context it is used
