...
// RegistrationAWSAccountExtV2 registration AWS account ext v2
//
...
// Validate validates this registration AWS account ext v2
...
// ContextValidate validates this registration AWS account ext v2 based on context it is used
