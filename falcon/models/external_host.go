...
func (m *ExternalHost) validateGroups(formats strfmt.Registry) error {
...
func (m *ExternalHost) contextValidateGroups(ctx context.Context, formats strfmt.Registry) error {
