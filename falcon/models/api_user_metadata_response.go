...
func (m *APIUserMetadataResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *APIUserMetadataResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *APIUserMetadataResponse) validateResources(formats strfmt.Registry) error {
...
func (m *APIUserMetadataResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APIUserMetadataResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APIUserMetadataResponse) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APIUserMetadataResponse) UnmarshalBinary(b []byte) error {
	var res APIUserMetadataResponse
