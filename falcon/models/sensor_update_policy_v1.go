...
func (m *SensorUpdatePolicyV1) validateCID(formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV1) validateCreatedBy(formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV1) validateCreatedTimestamp(formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV1) validateDescription(formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV1) validateEnabled(formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV1) validateGroups(formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV1) validateID(formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV1) validateModifiedBy(formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV1) validateModifiedTimestamp(formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV1) validateName(formats strfmt.Registry) error {
...
var sensorUpdatePolicyV1TypePlatformNamePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		sensorUpdatePolicyV1TypePlatformNamePropEnum = append(sensorUpdatePolicyV1TypePlatformNamePropEnum, v)
	}
}
...
// prop value enum
func (m *SensorUpdatePolicyV1) validatePlatformNameEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, sensorUpdatePolicyV1TypePlatformNamePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *SensorUpdatePolicyV1) validatePlatformName(formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV1) validateSettings(formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV1) contextValidateGroups(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV1) contextValidateSettings(ctx context.Context, formats strfmt.Registry) error {
