...
func (m *APIMsaExternalIncidentResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *APIMsaExternalIncidentResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *APIMsaExternalIncidentResponse) validateResources(formats strfmt.Registry) error {
...
func (m *APIMsaExternalIncidentResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APIMsaExternalIncidentResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APIMsaExternalIncidentResponse) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APIMsaExternalIncidentResponse) UnmarshalBinary(b []byte) error {
	var res APIMsaExternalIncidentResponse
