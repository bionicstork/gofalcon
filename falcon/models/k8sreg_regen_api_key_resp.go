...
func (m *K8sregRegenAPIKeyResp) validateErrors(formats strfmt.Registry) error {
...
func (m *K8sregRegenAPIKeyResp) validateMeta(formats strfmt.Registry) error {
...
func (m *K8sregRegenAPIKeyResp) validateResources(formats strfmt.Registry) error {
...
func (m *K8sregRegenAPIKeyResp) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8sregRegenAPIKeyResp) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8sregRegenAPIKeyResp) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
