...
func (m *SchemaSensorFieldResponseV1) validateErrors(formats strfmt.Registry) error {
...
func (m *SchemaSensorFieldResponseV1) validateMeta(formats strfmt.Registry) error {
...
func (m *SchemaSensorFieldResponseV1) validateResources(formats strfmt.Registry) error {
...
func (m *SchemaSensorFieldResponseV1) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SchemaSensorFieldResponseV1) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SchemaSensorFieldResponseV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SchemaSensorFieldResponseV1) UnmarshalBinary(b []byte) error {
	var res SchemaSensorFieldResponseV1
