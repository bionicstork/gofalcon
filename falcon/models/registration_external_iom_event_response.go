...
// RegistrationExternalIOMEventResponse registration external IOM event response
//
...
// Validate validates this registration external IOM event response
...
// ContextValidate validate this registration external IOM event response based on the context it is used
