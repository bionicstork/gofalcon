...
func (m *DomainInitResponseWrapper) validateErrors(formats strfmt.Registry) error {
...
func (m *DomainInitResponseWrapper) validateMeta(formats strfmt.Registry) error {
...
func (m *DomainInitResponseWrapper) validateResources(formats strfmt.Registry) error {
...
func (m *DomainInitResponseWrapper) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainInitResponseWrapper) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainInitResponseWrapper) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainInitResponseWrapper) UnmarshalBinary(b []byte) error {
	var res DomainInitResponseWrapper
