...
func (m *RequestsCreateGroupsV1) validateResources(formats strfmt.Registry) error {
...
func (m *RequestsCreateGroupsV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RequestsCreateGroupsV1) UnmarshalBinary(b []byte) error {
	var res RequestsCreateGroupsV1
