...
func (m *DomainPublicIndicatorsV3Response) validateErrors(formats strfmt.Registry) error {
...
func (m *DomainPublicIndicatorsV3Response) validateMeta(formats strfmt.Registry) error {
...
func (m *DomainPublicIndicatorsV3Response) validateResources(formats strfmt.Registry) error {
...
func (m *DomainPublicIndicatorsV3Response) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainPublicIndicatorsV3Response) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainPublicIndicatorsV3Response) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainPublicIndicatorsV3Response) UnmarshalBinary(b []byte) error {
	var res DomainPublicIndicatorsV3Response
