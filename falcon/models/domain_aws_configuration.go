...
// DomainAWSConfiguration domain AWS configuration
//
...
// Validate validates this domain AWS configuration
func (m *DomainAWSConfiguration) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this domain AWS configuration based on context it is used
