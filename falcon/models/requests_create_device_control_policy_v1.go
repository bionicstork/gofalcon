...
func (m *RequestsCreateDeviceControlPolicyV1) validateName(formats strfmt.Registry) error {
...
var requestsCreateDeviceControlPolicyV1TypePlatformNamePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		requestsCreateDeviceControlPolicyV1TypePlatformNamePropEnum = append(requestsCreateDeviceControlPolicyV1TypePlatformNamePropEnum, v)
	}
}
...
// prop value enum
func (m *RequestsCreateDeviceControlPolicyV1) validatePlatformNameEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, requestsCreateDeviceControlPolicyV1TypePlatformNamePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *RequestsCreateDeviceControlPolicyV1) validatePlatformName(formats strfmt.Registry) error {
...
func (m *RequestsCreateDeviceControlPolicyV1) validateSettings(formats strfmt.Registry) error {
...
func (m *RequestsCreateDeviceControlPolicyV1) contextValidateSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RequestsCreateDeviceControlPolicyV1) UnmarshalBinary(b []byte) error {
	var res RequestsCreateDeviceControlPolicyV1
