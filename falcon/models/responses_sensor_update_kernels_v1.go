...
func (m *ResponsesSensorUpdateKernelsV1) validateErrors(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdateKernelsV1) validateMeta(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdateKernelsV1) validateResources(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdateKernelsV1) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdateKernelsV1) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdateKernelsV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdateKernelsV1) UnmarshalBinary(b []byte) error {
	var res ResponsesSensorUpdateKernelsV1
