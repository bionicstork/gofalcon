...
func (m *RequestsUpdateFirewallPoliciesV1) validateResources(formats strfmt.Registry) error {
...
func (m *RequestsUpdateFirewallPoliciesV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RequestsUpdateFirewallPoliciesV1) UnmarshalBinary(b []byte) error {
	var res RequestsUpdateFirewallPoliciesV1
