...
func (m *DomainAssessmentsResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *DomainAssessmentsResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *DomainAssessmentsResponse) validateResources(formats strfmt.Registry) error {
...
func (m *DomainAssessmentsResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainAssessmentsResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainAssessmentsResponse) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainAssessmentsResponse) UnmarshalBinary(b []byte) error {
	var res DomainAssessmentsResponse
