...
func (m *RequestsUpdatePreventionPoliciesV1) validateResources(formats strfmt.Registry) error {
...
func (m *RequestsUpdatePreventionPoliciesV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RequestsUpdatePreventionPoliciesV1) UnmarshalBinary(b []byte) error {
	var res RequestsUpdatePreventionPoliciesV1
