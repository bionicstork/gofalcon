...
// DomainSPAPIQueryMeta domain SPAPI query meta
//
...
// Validate validates this domain SPAPI query meta
...
// ContextValidate validate this domain SPAPI query meta based on the context it is used
