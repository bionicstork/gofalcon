...
func (m *MalqueryRateLimitsResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *MalqueryRateLimitsResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *MalqueryRateLimitsResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MalqueryRateLimitsResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MalqueryRateLimitsResponse) UnmarshalBinary(b []byte) error {
	var res MalqueryRateLimitsResponse
