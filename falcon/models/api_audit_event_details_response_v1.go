...
func (m *APIAuditEventDetailsResponseV1) validateErrors(formats strfmt.Registry) error {
...
func (m *APIAuditEventDetailsResponseV1) validateMeta(formats strfmt.Registry) error {
...
func (m *APIAuditEventDetailsResponseV1) validateResources(formats strfmt.Registry) error {
...
func (m *APIAuditEventDetailsResponseV1) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APIAuditEventDetailsResponseV1) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APIAuditEventDetailsResponseV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APIAuditEventDetailsResponseV1) UnmarshalBinary(b []byte) error {
	var res APIAuditEventDetailsResponseV1
