...
func (m *RequestsUpdateDeviceControlPoliciesV1) validateResources(formats strfmt.Registry) error {
...
func (m *RequestsUpdateDeviceControlPoliciesV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RequestsUpdateDeviceControlPoliciesV1) UnmarshalBinary(b []byte) error {
	var res RequestsUpdateDeviceControlPoliciesV1
