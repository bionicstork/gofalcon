...
func (m *APIScheduledReportsResultV1) validateErrors(formats strfmt.Registry) error {
...
func (m *APIScheduledReportsResultV1) validateMeta(formats strfmt.Registry) error {
...
func (m *APIScheduledReportsResultV1) validateResources(formats strfmt.Registry) error {
...
func (m *APIScheduledReportsResultV1) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APIScheduledReportsResultV1) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APIScheduledReportsResultV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APIScheduledReportsResultV1) UnmarshalBinary(b []byte) error {
	var res APIScheduledReportsResultV1
