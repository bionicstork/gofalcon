...
func (m *ResponsesSensorUpdatePolicyV2) validateCid(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV2) validateCreatedBy(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV2) validateCreatedTimestamp(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV2) validateDescription(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV2) validateEnabled(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV2) validateGroups(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV2) validateID(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV2) validateModifiedBy(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV2) validateModifiedTimestamp(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV2) validateName(formats strfmt.Registry) error {
...
var responsesSensorUpdatePolicyV2TypePlatformNamePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		responsesSensorUpdatePolicyV2TypePlatformNamePropEnum = append(responsesSensorUpdatePolicyV2TypePlatformNamePropEnum, v)
	}
}
...
// prop value enum
func (m *ResponsesSensorUpdatePolicyV2) validatePlatformNameEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, responsesSensorUpdatePolicyV2TypePlatformNamePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ResponsesSensorUpdatePolicyV2) validatePlatformName(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV2) validateSettings(formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV2) contextValidateGroups(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV2) contextValidateSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponsesSensorUpdatePolicyV2) UnmarshalBinary(b []byte) error {
	var res ResponsesSensorUpdatePolicyV2
