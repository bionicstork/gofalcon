...
func (m *APIMsaExternalBehaviorResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *APIMsaExternalBehaviorResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *APIMsaExternalBehaviorResponse) validateResources(formats strfmt.Registry) error {
...
func (m *APIMsaExternalBehaviorResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APIMsaExternalBehaviorResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APIMsaExternalBehaviorResponse) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APIMsaExternalBehaviorResponse) UnmarshalBinary(b []byte) error {
	var res APIMsaExternalBehaviorResponse
