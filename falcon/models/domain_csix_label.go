...
// DomainCSIXLabel domain CSIX label
//
...
// Validate validates this domain CSIX label
...
// ContextValidate validates this domain CSIX label based on context it is used
