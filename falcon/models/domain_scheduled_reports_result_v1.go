...
func (m *DomainScheduledReportsResultV1) validateErrors(formats strfmt.Registry) error {
...
func (m *DomainScheduledReportsResultV1) validateMeta(formats strfmt.Registry) error {
...
func (m *DomainScheduledReportsResultV1) validateResources(formats strfmt.Registry) error {
...
func (m *DomainScheduledReportsResultV1) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainScheduledReportsResultV1) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainScheduledReportsResultV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainScheduledReportsResultV1) UnmarshalBinary(b []byte) error {
	var res DomainScheduledReportsResultV1
