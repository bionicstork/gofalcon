...
func (m *K8sregGetAzureTenantInfoResp) validateErrors(formats strfmt.Registry) error {
...
func (m *K8sregGetAzureTenantInfoResp) validateMeta(formats strfmt.Registry) error {
...
func (m *K8sregGetAzureTenantInfoResp) validateResources(formats strfmt.Registry) error {
...
func (m *K8sregGetAzureTenantInfoResp) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8sregGetAzureTenantInfoResp) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8sregGetAzureTenantInfoResp) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8sregGetAzureTenantInfoResp) UnmarshalBinary(b []byte) error {
	var res K8sregGetAzureTenantInfoResp
