...
func (m *SensorUpdatePolicyV2) validateCID(formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV2) validateCreatedBy(formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV2) validateCreatedTimestamp(formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV2) validateDescription(formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV2) validateEnabled(formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV2) validateGroups(formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV2) validateID(formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV2) validateModifiedBy(formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV2) validateModifiedTimestamp(formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV2) validateName(formats strfmt.Registry) error {
...
var sensorUpdatePolicyV2TypePlatformNamePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		sensorUpdatePolicyV2TypePlatformNamePropEnum = append(sensorUpdatePolicyV2TypePlatformNamePropEnum, v)
	}
}
...
// prop value enum
func (m *SensorUpdatePolicyV2) validatePlatformNameEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, sensorUpdatePolicyV2TypePlatformNamePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *SensorUpdatePolicyV2) validatePlatformName(formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV2) validateSettings(formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV2) contextValidateGroups(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SensorUpdatePolicyV2) contextValidateSettings(ctx context.Context, formats strfmt.Registry) error {
