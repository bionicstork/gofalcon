...
// EntitiesODSScanRequest entities ODS scan request
//
...
// Validate validates this entities ODS scan request
...
// ContextValidate validates this entities ODS scan request based on context it is used
