...
func (m *RequestsCreateSensorUpdatePoliciesV2) validateResources(formats strfmt.Registry) error {
...
func (m *RequestsCreateSensorUpdatePoliciesV2) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RequestsCreateSensorUpdatePoliciesV2) UnmarshalBinary(b []byte) error {
	var res RequestsCreateSensorUpdatePoliciesV2
