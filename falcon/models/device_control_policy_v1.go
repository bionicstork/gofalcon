...
func (m *DeviceControlPolicyV1) validateCreatedBy(formats strfmt.Registry) error {
...
func (m *DeviceControlPolicyV1) validateCreatedTimestamp(formats strfmt.Registry) error {
...
func (m *DeviceControlPolicyV1) validateDescription(formats strfmt.Registry) error {
...
func (m *DeviceControlPolicyV1) validateEnabled(formats strfmt.Registry) error {
...
func (m *DeviceControlPolicyV1) validateGroups(formats strfmt.Registry) error {
...
func (m *DeviceControlPolicyV1) validateID(formats strfmt.Registry) error {
...
func (m *DeviceControlPolicyV1) validateModifiedBy(formats strfmt.Registry) error {
...
func (m *DeviceControlPolicyV1) validateModifiedTimestamp(formats strfmt.Registry) error {
...
func (m *DeviceControlPolicyV1) validateName(formats strfmt.Registry) error {
...
var deviceControlPolicyV1TypePlatformNamePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		deviceControlPolicyV1TypePlatformNamePropEnum = append(deviceControlPolicyV1TypePlatformNamePropEnum, v)
	}
}
...
// prop value enum
func (m *DeviceControlPolicyV1) validatePlatformNameEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deviceControlPolicyV1TypePlatformNamePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *DeviceControlPolicyV1) validatePlatformName(formats strfmt.Registry) error {
...
func (m *DeviceControlPolicyV1) validateSettings(formats strfmt.Registry) error {
...
func (m *DeviceControlPolicyV1) contextValidateGroups(ctx context.Context, formats strfmt.Registry) error {
