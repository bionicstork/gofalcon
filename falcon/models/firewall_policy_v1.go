...
func (m *FirewallPolicyV1) validateChannelVersion(formats strfmt.Registry) error {
...
func (m *FirewallPolicyV1) validateCID(formats strfmt.Registry) error {
...
func (m *FirewallPolicyV1) validateCreatedBy(formats strfmt.Registry) error {
...
func (m *FirewallPolicyV1) validateCreatedTimestamp(formats strfmt.Registry) error {
...
func (m *FirewallPolicyV1) validateDescription(formats strfmt.Registry) error {
...
func (m *FirewallPolicyV1) validateEnabled(formats strfmt.Registry) error {
...
func (m *FirewallPolicyV1) validateGroups(formats strfmt.Registry) error {
...
func (m *FirewallPolicyV1) validateID(formats strfmt.Registry) error {
...
func (m *FirewallPolicyV1) validateModifiedBy(formats strfmt.Registry) error {
...
func (m *FirewallPolicyV1) validateModifiedTimestamp(formats strfmt.Registry) error {
...
func (m *FirewallPolicyV1) validateName(formats strfmt.Registry) error {
...
var firewallPolicyV1TypePlatformNamePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		firewallPolicyV1TypePlatformNamePropEnum = append(firewallPolicyV1TypePlatformNamePropEnum, v)
	}
}
...
// prop value enum
func (m *FirewallPolicyV1) validatePlatformNameEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, firewallPolicyV1TypePlatformNamePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *FirewallPolicyV1) validatePlatformName(formats strfmt.Registry) error {
...
func (m *FirewallPolicyV1) validateRuleSetID(formats strfmt.Registry) error {
...
func (m *FirewallPolicyV1) contextValidateGroups(ctx context.Context, formats strfmt.Registry) error {
