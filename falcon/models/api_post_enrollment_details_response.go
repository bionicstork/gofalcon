...
func (m *APIPostEnrollmentDetailsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APIPostEnrollmentDetailsResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *APIPostEnrollmentDetailsResponse) validateResources(formats strfmt.Registry) error {
...
func (m *APIPostEnrollmentDetailsResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APIPostEnrollmentDetailsResponse) UnmarshalBinary(b []byte) error {
	var res APIPostEnrollmentDetailsResponse
