...
func (m *DomainErrorsOnly) validateErrors(formats strfmt.Registry) error {
...
func (m *DomainErrorsOnly) validateMeta(formats strfmt.Registry) error {
...
func (m *DomainErrorsOnly) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainErrorsOnly) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
