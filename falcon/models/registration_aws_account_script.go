...
// RegistrationAWSAccountScript registration AWS account script
//
...
// Validate validates this registration AWS account script
func (m *RegistrationAWSAccountScript) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this registration AWS account script based on context it is used
