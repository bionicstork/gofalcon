...
func (m *RequestsCreateFirewallPoliciesV1) validateResources(formats strfmt.Registry) error {
...
func (m *RequestsCreateFirewallPoliciesV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RequestsCreateFirewallPoliciesV1) UnmarshalBinary(b []byte) error {
	var res RequestsCreateFirewallPoliciesV1
