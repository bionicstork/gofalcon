...
func (m *RequestsUpdateRTResponsePoliciesV1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RequestsUpdateRTResponsePoliciesV1) validateResources(formats strfmt.Registry) error {
...
func (m *RequestsUpdateRTResponsePoliciesV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RequestsUpdateRTResponsePoliciesV1) UnmarshalBinary(b []byte) error {
	var res RequestsUpdateRTResponsePoliciesV1
