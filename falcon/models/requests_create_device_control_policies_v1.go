...
func (m *RequestsCreateDeviceControlPoliciesV1) validateResources(formats strfmt.Registry) error {
...
func (m *RequestsCreateDeviceControlPoliciesV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RequestsCreateDeviceControlPoliciesV1) UnmarshalBinary(b []byte) error {
	var res RequestsCreateDeviceControlPoliciesV1
