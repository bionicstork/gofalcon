...
func (m *DomainListFilesResponseWrapper) validateErrors(formats strfmt.Registry) error {
...
func (m *DomainListFilesResponseWrapper) validateMeta(formats strfmt.Registry) error {
...
func (m *DomainListFilesResponseWrapper) validateResources(formats strfmt.Registry) error {
...
func (m *DomainListFilesResponseWrapper) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainListFilesResponseWrapper) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainListFilesResponseWrapper) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainListFilesResponseWrapper) UnmarshalBinary(b []byte) error {
	var res DomainListFilesResponseWrapper
