...
// RegistrationGCPAccountExtV1 registration GCP account ext v1
//
...
// Validate validates this registration GCP account ext v1
...
// ContextValidate validates this registration GCP account ext v1 based on context it is used
