...
// IsSuccess returns true when this query Aws accounts for i ds o k response has a 2xx status code
func (o *QueryAWSAccountsForIDsOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this query Aws accounts for i ds o k response has a 3xx status code
func (o *QueryAWSAccountsForIDsOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this query Aws accounts for i ds o k response has a 4xx status code
func (o *QueryAWSAccountsForIDsOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this query Aws accounts for i ds o k response has a 5xx status code
func (o *QueryAWSAccountsForIDsOK) IsServerError() bool {
	return false
}

// IsCode returns true when this query Aws accounts for i ds o k response a status code equal to that given
func (o *QueryAWSAccountsForIDsOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the query Aws accounts for i ds o k response
...
// IsSuccess returns true when this query Aws accounts for i ds bad request response has a 2xx status code
func (o *QueryAWSAccountsForIDsBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this query Aws accounts for i ds bad request response has a 3xx status code
func (o *QueryAWSAccountsForIDsBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this query Aws accounts for i ds bad request response has a 4xx status code
func (o *QueryAWSAccountsForIDsBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this query Aws accounts for i ds bad request response has a 5xx status code
func (o *QueryAWSAccountsForIDsBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this query Aws accounts for i ds bad request response a status code equal to that given
func (o *QueryAWSAccountsForIDsBadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the query Aws accounts for i ds bad request response
...
// IsSuccess returns true when this query Aws accounts for i ds forbidden response has a 2xx status code
func (o *QueryAWSAccountsForIDsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this query Aws accounts for i ds forbidden response has a 3xx status code
func (o *QueryAWSAccountsForIDsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this query Aws accounts for i ds forbidden response has a 4xx status code
func (o *QueryAWSAccountsForIDsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this query Aws accounts for i ds forbidden response has a 5xx status code
func (o *QueryAWSAccountsForIDsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this query Aws accounts for i ds forbidden response a status code equal to that given
func (o *QueryAWSAccountsForIDsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the query Aws accounts for i ds forbidden response
...
// IsSuccess returns true when this query Aws accounts for i ds too many requests response has a 2xx status code
func (o *QueryAWSAccountsForIDsTooManyRequests) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this query Aws accounts for i ds too many requests response has a 3xx status code
func (o *QueryAWSAccountsForIDsTooManyRequests) IsRedirect() bool {
	return false
}

// IsClientError returns true when this query Aws accounts for i ds too many requests response has a 4xx status code
func (o *QueryAWSAccountsForIDsTooManyRequests) IsClientError() bool {
	return true
}

// IsServerError returns true when this query Aws accounts for i ds too many requests response has a 5xx status code
func (o *QueryAWSAccountsForIDsTooManyRequests) IsServerError() bool {
	return false
}

// IsCode returns true when this query Aws accounts for i ds too many requests response a status code equal to that given
func (o *QueryAWSAccountsForIDsTooManyRequests) IsCode(code int) bool {
	return code == 429
}

// Code gets the status code for the query Aws accounts for i ds too many requests response
...
// IsSuccess returns true when this query Aws accounts for i ds internal server error response has a 2xx status code
func (o *QueryAWSAccountsForIDsInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this query Aws accounts for i ds internal server error response has a 3xx status code
func (o *QueryAWSAccountsForIDsInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this query Aws accounts for i ds internal server error response has a 4xx status code
func (o *QueryAWSAccountsForIDsInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this query Aws accounts for i ds internal server error response has a 5xx status code
func (o *QueryAWSAccountsForIDsInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this query Aws accounts for i ds internal server error response a status code equal to that given
func (o *QueryAWSAccountsForIDsInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the query Aws accounts for i ds internal server error response
