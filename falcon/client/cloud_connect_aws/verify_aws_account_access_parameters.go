...
VerifyAWSAccountAccessParams contains all the parameters to send to the API endpoint
	...
	for the verify AWS account access operation.
...
// WithDefaults hydrates default values in the verify AWS account access params (not the query body).
//
...
// SetDefaults hydrates default values in the verify AWS account access params (not the query body).
//
// All values with no default are reset to their zero value.
...
// bindParamVerifyAWSAccountAccess binds the parameter ids
func (o *VerifyAWSAccountAccessParams) bindParamIds(formats strfmt.Registry) []string {
	idsIR := o.Ids
