...
UpdateAWSAccountsParams contains all the parameters to send to the API endpoint
	...
	for the update AWS accounts operation.
...
// WithDefaults hydrates default values in the update AWS accounts params (not the query body).
//
...
// SetDefaults hydrates default values in the update AWS accounts params (not the query body).
//
// All values with no default are reset to their zero value.
...
// WithBody adds the body to the update AWS accounts params
func (o *UpdateAWSAccountsParams) WithBody(body *models.ModelsUpdateAWSAccountsV1) *UpdateAWSAccountsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update AWS accounts params
