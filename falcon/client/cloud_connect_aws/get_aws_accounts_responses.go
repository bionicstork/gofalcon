...
// IsSuccess returns true when this get Aws accounts o k response has a 2xx status code
func (o *GetAWSAccountsOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get Aws accounts o k response has a 3xx status code
func (o *GetAWSAccountsOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Aws accounts o k response has a 4xx status code
func (o *GetAWSAccountsOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get Aws accounts o k response has a 5xx status code
func (o *GetAWSAccountsOK) IsServerError() bool {
	return false
}

// IsCode returns true when this get Aws accounts o k response a status code equal to that given
func (o *GetAWSAccountsOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get Aws accounts o k response
...
// IsSuccess returns true when this get Aws accounts bad request response has a 2xx status code
func (o *GetAWSAccountsBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Aws accounts bad request response has a 3xx status code
func (o *GetAWSAccountsBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Aws accounts bad request response has a 4xx status code
func (o *GetAWSAccountsBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this get Aws accounts bad request response has a 5xx status code
func (o *GetAWSAccountsBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this get Aws accounts bad request response a status code equal to that given
func (o *GetAWSAccountsBadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the get Aws accounts bad request response
...
// IsSuccess returns true when this get Aws accounts forbidden response has a 2xx status code
func (o *GetAWSAccountsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Aws accounts forbidden response has a 3xx status code
func (o *GetAWSAccountsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Aws accounts forbidden response has a 4xx status code
func (o *GetAWSAccountsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get Aws accounts forbidden response has a 5xx status code
func (o *GetAWSAccountsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get Aws accounts forbidden response a status code equal to that given
func (o *GetAWSAccountsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get Aws accounts forbidden response
...
// IsSuccess returns true when this get Aws accounts not found response has a 2xx status code
func (o *GetAWSAccountsNotFound) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Aws accounts not found response has a 3xx status code
func (o *GetAWSAccountsNotFound) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Aws accounts not found response has a 4xx status code
func (o *GetAWSAccountsNotFound) IsClientError() bool {
	return true
}

// IsServerError returns true when this get Aws accounts not found response has a 5xx status code
func (o *GetAWSAccountsNotFound) IsServerError() bool {
	return false
}

// IsCode returns true when this get Aws accounts not found response a status code equal to that given
func (o *GetAWSAccountsNotFound) IsCode(code int) bool {
	return code == 404
}

// Code gets the status code for the get Aws accounts not found response
...
// IsSuccess returns true when this get Aws accounts too many requests response has a 2xx status code
func (o *GetAWSAccountsTooManyRequests) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Aws accounts too many requests response has a 3xx status code
func (o *GetAWSAccountsTooManyRequests) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Aws accounts too many requests response has a 4xx status code
func (o *GetAWSAccountsTooManyRequests) IsClientError() bool {
	return true
}

// IsServerError returns true when this get Aws accounts too many requests response has a 5xx status code
func (o *GetAWSAccountsTooManyRequests) IsServerError() bool {
	return false
}

// IsCode returns true when this get Aws accounts too many requests response a status code equal to that given
func (o *GetAWSAccountsTooManyRequests) IsCode(code int) bool {
	return code == 429
}

// Code gets the status code for the get Aws accounts too many requests response
...
// IsSuccess returns true when this get Aws accounts internal server error response has a 2xx status code
func (o *GetAWSAccountsInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Aws accounts internal server error response has a 3xx status code
func (o *GetAWSAccountsInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Aws accounts internal server error response has a 4xx status code
func (o *GetAWSAccountsInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this get Aws accounts internal server error response has a 5xx status code
func (o *GetAWSAccountsInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this get Aws accounts internal server error response a status code equal to that given
func (o *GetAWSAccountsInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the get Aws accounts internal server error response
