...
GetCSPMAzureUserScriptsAttachmentParams contains all the parameters to send to the API endpoint
	...
	for the get CSPM azure user scripts attachment operation.
...
// WithDefaults hydrates default values in the get CSPM azure user scripts attachment params (not the query body).
//
...
// SetDefaults hydrates default values in the get CSPM azure user scripts attachment params (not the query body).
//
// All values with no default are reset to their zero value.
...
// WithTimeout adds the timeout to the get CSPM azure user scripts attachment params
...
// SetTimeout adds the timeout to the get CSPM azure user scripts attachment params
func (o *GetCSPMAzureUserScriptsAttachmentParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get CSPM azure user scripts attachment params
func (o *GetCSPMAzureUserScriptsAttachmentParams) WithContext(ctx context.Context) *GetCSPMAzureUserScriptsAttachmentParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get CSPM azure user scripts attachment params
func (o *GetCSPMAzureUserScriptsAttachmentParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get CSPM azure user scripts attachment params
...
// SetHTTPClient adds the HTTPClient to the get CSPM azure user scripts attachment params
func (o *GetCSPMAzureUserScriptsAttachmentParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithAccountType adds the accountType to the get CSPM azure user scripts attachment params
...
// SetAccountType adds the accountType to the get CSPM azure user scripts attachment params
func (o *GetCSPMAzureUserScriptsAttachmentParams) SetAccountType(accountType *string) {
	o.AccountType = accountType
}

// WithSubscriptionIds adds the subscriptionIds to the get CSPM azure user scripts attachment params
...
// SetSubscriptionIds adds the subscriptionIds to the get CSPM azure user scripts attachment params
...
// WithTemplate adds the template to the get CSPM azure user scripts attachment params
func (o *GetCSPMAzureUserScriptsAttachmentParams) WithTemplate(template *string) *GetCSPMAzureUserScriptsAttachmentParams {
	o.SetTemplate(template)
	return o
}

// SetTemplate adds the template to the get CSPM azure user scripts attachment params
func (o *GetCSPMAzureUserScriptsAttachmentParams) SetTemplate(template *string) {
	o.Template = template
}

// WithTenantID adds the tenantID to the get CSPM azure user scripts attachment params
func (o *GetCSPMAzureUserScriptsAttachmentParams) WithTenantID(tenantID *string) *GetCSPMAzureUserScriptsAttachmentParams {
	o.SetTenantID(tenantID)
	return o
}

// SetTenantID adds the tenantId to the get CSPM azure user scripts attachment params
