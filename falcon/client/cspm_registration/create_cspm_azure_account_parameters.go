...
CreateCSPMAzureAccountParams contains all the parameters to send to the API endpoint
	...
	for the create CSPM azure account operation.
...
// WithDefaults hydrates default values in the create CSPM azure account params (not the query body).
//
...
// SetDefaults hydrates default values in the create CSPM azure account params (not the query body).
//
// All values with no default are reset to their zero value.
...
// SetBody adds the body to the create CSPM azure account params
