...
GetCSPMAWSAccountScriptsAttachmentParams contains all the parameters to send to the API endpoint
	...
	for the get CSPM Aws account scripts attachment operation.
...
// WithDefaults hydrates default values in the get CSPM Aws account scripts attachment params (not the query body).
//
...
// SetDefaults hydrates default values in the get CSPM Aws account scripts attachment params (not the query body).
//
// All values with no default are reset to their zero value.
...
// WithTimeout adds the timeout to the get CSPM Aws account scripts attachment params
...
// SetTimeout adds the timeout to the get CSPM Aws account scripts attachment params
func (o *GetCSPMAWSAccountScriptsAttachmentParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get CSPM Aws account scripts attachment params
func (o *GetCSPMAWSAccountScriptsAttachmentParams) WithContext(ctx context.Context) *GetCSPMAWSAccountScriptsAttachmentParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get CSPM Aws account scripts attachment params
func (o *GetCSPMAWSAccountScriptsAttachmentParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get CSPM Aws account scripts attachment params
...
// SetHTTPClient adds the HTTPClient to the get CSPM Aws account scripts attachment params
func (o *GetCSPMAWSAccountScriptsAttachmentParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithIds adds the ids to the get CSPM Aws account scripts attachment params
func (o *GetCSPMAWSAccountScriptsAttachmentParams) WithIds(ids []string) *GetCSPMAWSAccountScriptsAttachmentParams {
	o.SetIds(ids)
	return o
}

// SetIds adds the ids to the get CSPM Aws account scripts attachment params
