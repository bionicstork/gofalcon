...
// IsSuccess returns true when this get Cspm scan schedule o k response has a 2xx status code
func (o *GetCSPMScanScheduleOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get Cspm scan schedule o k response has a 3xx status code
func (o *GetCSPMScanScheduleOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cspm scan schedule o k response has a 4xx status code
func (o *GetCSPMScanScheduleOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get Cspm scan schedule o k response has a 5xx status code
func (o *GetCSPMScanScheduleOK) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cspm scan schedule o k response a status code equal to that given
func (o *GetCSPMScanScheduleOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get Cspm scan schedule o k response
...
// IsSuccess returns true when this get Cspm scan schedule bad request response has a 2xx status code
func (o *GetCSPMScanScheduleBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Cspm scan schedule bad request response has a 3xx status code
func (o *GetCSPMScanScheduleBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cspm scan schedule bad request response has a 4xx status code
func (o *GetCSPMScanScheduleBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this get Cspm scan schedule bad request response has a 5xx status code
func (o *GetCSPMScanScheduleBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cspm scan schedule bad request response a status code equal to that given
func (o *GetCSPMScanScheduleBadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the get Cspm scan schedule bad request response
...
// IsSuccess returns true when this get Cspm scan schedule forbidden response has a 2xx status code
func (o *GetCSPMScanScheduleForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Cspm scan schedule forbidden response has a 3xx status code
func (o *GetCSPMScanScheduleForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cspm scan schedule forbidden response has a 4xx status code
func (o *GetCSPMScanScheduleForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get Cspm scan schedule forbidden response has a 5xx status code
func (o *GetCSPMScanScheduleForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cspm scan schedule forbidden response a status code equal to that given
func (o *GetCSPMScanScheduleForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get Cspm scan schedule forbidden response
...
// IsSuccess returns true when this get Cspm scan schedule too many requests response has a 2xx status code
func (o *GetCSPMScanScheduleTooManyRequests) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Cspm scan schedule too many requests response has a 3xx status code
func (o *GetCSPMScanScheduleTooManyRequests) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cspm scan schedule too many requests response has a 4xx status code
func (o *GetCSPMScanScheduleTooManyRequests) IsClientError() bool {
	return true
}

// IsServerError returns true when this get Cspm scan schedule too many requests response has a 5xx status code
func (o *GetCSPMScanScheduleTooManyRequests) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cspm scan schedule too many requests response a status code equal to that given
func (o *GetCSPMScanScheduleTooManyRequests) IsCode(code int) bool {
	return code == 429
}

// Code gets the status code for the get Cspm scan schedule too many requests response
...
// IsSuccess returns true when this get Cspm scan schedule internal server error response has a 2xx status code
func (o *GetCSPMScanScheduleInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Cspm scan schedule internal server error response has a 3xx status code
func (o *GetCSPMScanScheduleInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cspm scan schedule internal server error response has a 4xx status code
func (o *GetCSPMScanScheduleInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this get Cspm scan schedule internal server error response has a 5xx status code
func (o *GetCSPMScanScheduleInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this get Cspm scan schedule internal server error response a status code equal to that given
func (o *GetCSPMScanScheduleInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the get Cspm scan schedule internal server error response
