...
// IsSuccess returns true when this get Cspm policy o k response has a 2xx status code
func (o *GetCSPMPolicyOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get Cspm policy o k response has a 3xx status code
func (o *GetCSPMPolicyOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cspm policy o k response has a 4xx status code
func (o *GetCSPMPolicyOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get Cspm policy o k response has a 5xx status code
func (o *GetCSPMPolicyOK) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cspm policy o k response a status code equal to that given
func (o *GetCSPMPolicyOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get Cspm policy o k response
...
// IsSuccess returns true when this get Cspm policy multi status response has a 2xx status code
func (o *GetCSPMPolicyMultiStatus) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get Cspm policy multi status response has a 3xx status code
func (o *GetCSPMPolicyMultiStatus) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cspm policy multi status response has a 4xx status code
func (o *GetCSPMPolicyMultiStatus) IsClientError() bool {
	return false
}

// IsServerError returns true when this get Cspm policy multi status response has a 5xx status code
func (o *GetCSPMPolicyMultiStatus) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cspm policy multi status response a status code equal to that given
func (o *GetCSPMPolicyMultiStatus) IsCode(code int) bool {
	return code == 207
}

// Code gets the status code for the get Cspm policy multi status response
...
// IsSuccess returns true when this get Cspm policy bad request response has a 2xx status code
func (o *GetCSPMPolicyBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Cspm policy bad request response has a 3xx status code
func (o *GetCSPMPolicyBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cspm policy bad request response has a 4xx status code
func (o *GetCSPMPolicyBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this get Cspm policy bad request response has a 5xx status code
func (o *GetCSPMPolicyBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cspm policy bad request response a status code equal to that given
func (o *GetCSPMPolicyBadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the get Cspm policy bad request response
...
// IsSuccess returns true when this get Cspm policy forbidden response has a 2xx status code
func (o *GetCSPMPolicyForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Cspm policy forbidden response has a 3xx status code
func (o *GetCSPMPolicyForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cspm policy forbidden response has a 4xx status code
func (o *GetCSPMPolicyForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get Cspm policy forbidden response has a 5xx status code
func (o *GetCSPMPolicyForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cspm policy forbidden response a status code equal to that given
func (o *GetCSPMPolicyForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get Cspm policy forbidden response
...
// IsSuccess returns true when this get Cspm policy too many requests response has a 2xx status code
func (o *GetCSPMPolicyTooManyRequests) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Cspm policy too many requests response has a 3xx status code
func (o *GetCSPMPolicyTooManyRequests) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cspm policy too many requests response has a 4xx status code
func (o *GetCSPMPolicyTooManyRequests) IsClientError() bool {
	return true
}

// IsServerError returns true when this get Cspm policy too many requests response has a 5xx status code
func (o *GetCSPMPolicyTooManyRequests) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cspm policy too many requests response a status code equal to that given
func (o *GetCSPMPolicyTooManyRequests) IsCode(code int) bool {
	return code == 429
}

// Code gets the status code for the get Cspm policy too many requests response
...
// IsSuccess returns true when this get Cspm policy internal server error response has a 2xx status code
func (o *GetCSPMPolicyInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Cspm policy internal server error response has a 3xx status code
func (o *GetCSPMPolicyInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cspm policy internal server error response has a 4xx status code
func (o *GetCSPMPolicyInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this get Cspm policy internal server error response has a 5xx status code
func (o *GetCSPMPolicyInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this get Cspm policy internal server error response a status code equal to that given
func (o *GetCSPMPolicyInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the get Cspm policy internal server error response
