...
GetCSPMAzureAccountParams contains all the parameters to send to the API endpoint
	...
	for the get CSPM azure account operation.
...
// WithDefaults hydrates default values in the get CSPM azure account params (not the query body).
//
...
// SetDefaults hydrates default values in the get CSPM azure account params (not the query body).
//
// All values with no default are reset to their zero value.
