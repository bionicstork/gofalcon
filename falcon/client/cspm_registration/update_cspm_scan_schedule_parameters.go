...
UpdateCSPMScanScheduleParams contains all the parameters to send to the API endpoint
	...
	for the update CSPM scan schedule operation.
...
// WithDefaults hydrates default values in the update CSPM scan schedule params (not the query body).
//
...
// SetDefaults hydrates default values in the update CSPM scan schedule params (not the query body).
//
// All values with no default are reset to their zero value.
...
// SetBody adds the body to the update CSPM scan schedule params
