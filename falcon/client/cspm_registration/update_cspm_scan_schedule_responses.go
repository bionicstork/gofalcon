...
// IsSuccess returns true when this update Cspm scan schedule o k response has a 2xx status code
func (o *UpdateCSPMScanScheduleOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this update Cspm scan schedule o k response has a 3xx status code
func (o *UpdateCSPMScanScheduleOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update Cspm scan schedule o k response has a 4xx status code
func (o *UpdateCSPMScanScheduleOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this update Cspm scan schedule o k response has a 5xx status code
func (o *UpdateCSPMScanScheduleOK) IsServerError() bool {
	return false
}

// IsCode returns true when this update Cspm scan schedule o k response a status code equal to that given
func (o *UpdateCSPMScanScheduleOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the update Cspm scan schedule o k response
...
// IsSuccess returns true when this update Cspm scan schedule bad request response has a 2xx status code
func (o *UpdateCSPMScanScheduleBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update Cspm scan schedule bad request response has a 3xx status code
func (o *UpdateCSPMScanScheduleBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update Cspm scan schedule bad request response has a 4xx status code
func (o *UpdateCSPMScanScheduleBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this update Cspm scan schedule bad request response has a 5xx status code
func (o *UpdateCSPMScanScheduleBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this update Cspm scan schedule bad request response a status code equal to that given
func (o *UpdateCSPMScanScheduleBadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the update Cspm scan schedule bad request response
...
// IsSuccess returns true when this update Cspm scan schedule forbidden response has a 2xx status code
func (o *UpdateCSPMScanScheduleForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update Cspm scan schedule forbidden response has a 3xx status code
func (o *UpdateCSPMScanScheduleForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update Cspm scan schedule forbidden response has a 4xx status code
func (o *UpdateCSPMScanScheduleForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update Cspm scan schedule forbidden response has a 5xx status code
func (o *UpdateCSPMScanScheduleForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update Cspm scan schedule forbidden response a status code equal to that given
func (o *UpdateCSPMScanScheduleForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update Cspm scan schedule forbidden response
...
// IsSuccess returns true when this update Cspm scan schedule too many requests response has a 2xx status code
func (o *UpdateCSPMScanScheduleTooManyRequests) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update Cspm scan schedule too many requests response has a 3xx status code
func (o *UpdateCSPMScanScheduleTooManyRequests) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update Cspm scan schedule too many requests response has a 4xx status code
func (o *UpdateCSPMScanScheduleTooManyRequests) IsClientError() bool {
	return true
}

// IsServerError returns true when this update Cspm scan schedule too many requests response has a 5xx status code
func (o *UpdateCSPMScanScheduleTooManyRequests) IsServerError() bool {
	return false
}

// IsCode returns true when this update Cspm scan schedule too many requests response a status code equal to that given
func (o *UpdateCSPMScanScheduleTooManyRequests) IsCode(code int) bool {
	return code == 429
}

// Code gets the status code for the update Cspm scan schedule too many requests response
...
// IsSuccess returns true when this update Cspm scan schedule internal server error response has a 2xx status code
func (o *UpdateCSPMScanScheduleInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update Cspm scan schedule internal server error response has a 3xx status code
func (o *UpdateCSPMScanScheduleInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update Cspm scan schedule internal server error response has a 4xx status code
func (o *UpdateCSPMScanScheduleInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this update Cspm scan schedule internal server error response has a 5xx status code
func (o *UpdateCSPMScanScheduleInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this update Cspm scan schedule internal server error response a status code equal to that given
func (o *UpdateCSPMScanScheduleInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the update Cspm scan schedule internal server error response
