...
UpdateCSPMAzureTenantDefaultSubscriptionIDParams contains all the parameters to send to the API endpoint
	...
	for the update CSPM azure tenant default subscription ID operation.
...
// WithDefaults hydrates default values in the update CSPM azure tenant default subscription ID params (not the query body).
//
...
// SetDefaults hydrates default values in the update CSPM azure tenant default subscription ID params (not the query body).
//
// All values with no default are reset to their zero value.
...
// WithTimeout adds the timeout to the update CSPM azure tenant default subscription ID params
...
// SetTimeout adds the timeout to the update CSPM azure tenant default subscription ID params
func (o *UpdateCSPMAzureTenantDefaultSubscriptionIDParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the update CSPM azure tenant default subscription ID params
...
// SetContext adds the context to the update CSPM azure tenant default subscription ID params
func (o *UpdateCSPMAzureTenantDefaultSubscriptionIDParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the update CSPM azure tenant default subscription ID params
...
// SetHTTPClient adds the HTTPClient to the update CSPM azure tenant default subscription ID params
func (o *UpdateCSPMAzureTenantDefaultSubscriptionIDParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithSubscriptionID adds the subscriptionID to the update CSPM azure tenant default subscription ID params
...
// SetSubscriptionID adds the subscriptionId to the update CSPM azure tenant default subscription ID params
func (o *UpdateCSPMAzureTenantDefaultSubscriptionIDParams) SetSubscriptionID(subscriptionID string) {
	o.SubscriptionID = subscriptionID
}

// WithTenantID adds the tenantID to the update CSPM azure tenant default subscription ID params
...
// SetTenantID adds the tenantId to the update CSPM azure tenant default subscription ID params
