...
// IsSuccess returns true when this get Cspm policy settings o k response has a 2xx status code
func (o *GetCSPMPolicySettingsOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get Cspm policy settings o k response has a 3xx status code
func (o *GetCSPMPolicySettingsOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cspm policy settings o k response has a 4xx status code
func (o *GetCSPMPolicySettingsOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get Cspm policy settings o k response has a 5xx status code
func (o *GetCSPMPolicySettingsOK) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cspm policy settings o k response a status code equal to that given
func (o *GetCSPMPolicySettingsOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get Cspm policy settings o k response
...
// IsSuccess returns true when this get Cspm policy settings multi status response has a 2xx status code
func (o *GetCSPMPolicySettingsMultiStatus) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get Cspm policy settings multi status response has a 3xx status code
func (o *GetCSPMPolicySettingsMultiStatus) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cspm policy settings multi status response has a 4xx status code
func (o *GetCSPMPolicySettingsMultiStatus) IsClientError() bool {
	return false
}

// IsServerError returns true when this get Cspm policy settings multi status response has a 5xx status code
func (o *GetCSPMPolicySettingsMultiStatus) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cspm policy settings multi status response a status code equal to that given
func (o *GetCSPMPolicySettingsMultiStatus) IsCode(code int) bool {
	return code == 207
}

// Code gets the status code for the get Cspm policy settings multi status response
...
// IsSuccess returns true when this get Cspm policy settings bad request response has a 2xx status code
func (o *GetCSPMPolicySettingsBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Cspm policy settings bad request response has a 3xx status code
func (o *GetCSPMPolicySettingsBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cspm policy settings bad request response has a 4xx status code
func (o *GetCSPMPolicySettingsBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this get Cspm policy settings bad request response has a 5xx status code
func (o *GetCSPMPolicySettingsBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cspm policy settings bad request response a status code equal to that given
func (o *GetCSPMPolicySettingsBadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the get Cspm policy settings bad request response
...
// IsSuccess returns true when this get Cspm policy settings forbidden response has a 2xx status code
func (o *GetCSPMPolicySettingsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Cspm policy settings forbidden response has a 3xx status code
func (o *GetCSPMPolicySettingsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cspm policy settings forbidden response has a 4xx status code
func (o *GetCSPMPolicySettingsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get Cspm policy settings forbidden response has a 5xx status code
func (o *GetCSPMPolicySettingsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cspm policy settings forbidden response a status code equal to that given
func (o *GetCSPMPolicySettingsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get Cspm policy settings forbidden response
...
// IsSuccess returns true when this get Cspm policy settings too many requests response has a 2xx status code
func (o *GetCSPMPolicySettingsTooManyRequests) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Cspm policy settings too many requests response has a 3xx status code
func (o *GetCSPMPolicySettingsTooManyRequests) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cspm policy settings too many requests response has a 4xx status code
func (o *GetCSPMPolicySettingsTooManyRequests) IsClientError() bool {
	return true
}

// IsServerError returns true when this get Cspm policy settings too many requests response has a 5xx status code
func (o *GetCSPMPolicySettingsTooManyRequests) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cspm policy settings too many requests response a status code equal to that given
func (o *GetCSPMPolicySettingsTooManyRequests) IsCode(code int) bool {
	return code == 429
}

// Code gets the status code for the get Cspm policy settings too many requests response
...
// IsSuccess returns true when this get Cspm policy settings internal server error response has a 2xx status code
func (o *GetCSPMPolicySettingsInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Cspm policy settings internal server error response has a 3xx status code
func (o *GetCSPMPolicySettingsInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cspm policy settings internal server error response has a 4xx status code
func (o *GetCSPMPolicySettingsInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this get Cspm policy settings internal server error response has a 5xx status code
func (o *GetCSPMPolicySettingsInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this get Cspm policy settings internal server error response a status code equal to that given
func (o *GetCSPMPolicySettingsInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the get Cspm policy settings internal server error response
