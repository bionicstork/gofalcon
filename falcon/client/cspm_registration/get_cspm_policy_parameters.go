...
GetCSPMPolicyParams contains all the parameters to send to the API endpoint
	...
	for the get CSPM policy operation.
...
// WithDefaults hydrates default values in the get CSPM policy params (not the query body).
//
...
// SetDefaults hydrates default values in the get CSPM policy params (not the query body).
//
// All values with no default are reset to their zero value.
