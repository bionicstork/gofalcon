...
PatchCSPMAWSAccountParams contains all the parameters to send to the API endpoint
	...
	for the patch CSPM Aws account operation.
...
// WithDefaults hydrates default values in the patch CSPM Aws account params (not the query body).
//
...
// SetDefaults hydrates default values in the patch CSPM Aws account params (not the query body).
//
// All values with no default are reset to their zero value.
