...
// IsSuccess returns true when this create Cspm azure account created response has a 2xx status code
func (o *CreateCSPMAzureAccountCreated) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this create Cspm azure account created response has a 3xx status code
func (o *CreateCSPMAzureAccountCreated) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create Cspm azure account created response has a 4xx status code
func (o *CreateCSPMAzureAccountCreated) IsClientError() bool {
	return false
}

// IsServerError returns true when this create Cspm azure account created response has a 5xx status code
func (o *CreateCSPMAzureAccountCreated) IsServerError() bool {
	return false
}

// IsCode returns true when this create Cspm azure account created response a status code equal to that given
func (o *CreateCSPMAzureAccountCreated) IsCode(code int) bool {
	return code == 201
}

// Code gets the status code for the create Cspm azure account created response
...
// IsSuccess returns true when this create Cspm azure account multi status response has a 2xx status code
func (o *CreateCSPMAzureAccountMultiStatus) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this create Cspm azure account multi status response has a 3xx status code
func (o *CreateCSPMAzureAccountMultiStatus) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create Cspm azure account multi status response has a 4xx status code
func (o *CreateCSPMAzureAccountMultiStatus) IsClientError() bool {
	return false
}

// IsServerError returns true when this create Cspm azure account multi status response has a 5xx status code
func (o *CreateCSPMAzureAccountMultiStatus) IsServerError() bool {
	return false
}

// IsCode returns true when this create Cspm azure account multi status response a status code equal to that given
func (o *CreateCSPMAzureAccountMultiStatus) IsCode(code int) bool {
	return code == 207
}

// Code gets the status code for the create Cspm azure account multi status response
...
// IsSuccess returns true when this create Cspm azure account bad request response has a 2xx status code
func (o *CreateCSPMAzureAccountBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create Cspm azure account bad request response has a 3xx status code
func (o *CreateCSPMAzureAccountBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create Cspm azure account bad request response has a 4xx status code
func (o *CreateCSPMAzureAccountBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this create Cspm azure account bad request response has a 5xx status code
func (o *CreateCSPMAzureAccountBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this create Cspm azure account bad request response a status code equal to that given
func (o *CreateCSPMAzureAccountBadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the create Cspm azure account bad request response
...
// IsSuccess returns true when this create Cspm azure account forbidden response has a 2xx status code
func (o *CreateCSPMAzureAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create Cspm azure account forbidden response has a 3xx status code
func (o *CreateCSPMAzureAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create Cspm azure account forbidden response has a 4xx status code
func (o *CreateCSPMAzureAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this create Cspm azure account forbidden response has a 5xx status code
func (o *CreateCSPMAzureAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this create Cspm azure account forbidden response a status code equal to that given
func (o *CreateCSPMAzureAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the create Cspm azure account forbidden response
...
// IsSuccess returns true when this create Cspm azure account too many requests response has a 2xx status code
func (o *CreateCSPMAzureAccountTooManyRequests) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create Cspm azure account too many requests response has a 3xx status code
func (o *CreateCSPMAzureAccountTooManyRequests) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create Cspm azure account too many requests response has a 4xx status code
func (o *CreateCSPMAzureAccountTooManyRequests) IsClientError() bool {
	return true
}

// IsServerError returns true when this create Cspm azure account too many requests response has a 5xx status code
func (o *CreateCSPMAzureAccountTooManyRequests) IsServerError() bool {
	return false
}

// IsCode returns true when this create Cspm azure account too many requests response a status code equal to that given
func (o *CreateCSPMAzureAccountTooManyRequests) IsCode(code int) bool {
	return code == 429
}

// Code gets the status code for the create Cspm azure account too many requests response
...
// IsSuccess returns true when this create Cspm azure account internal server error response has a 2xx status code
func (o *CreateCSPMAzureAccountInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create Cspm azure account internal server error response has a 3xx status code
func (o *CreateCSPMAzureAccountInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create Cspm azure account internal server error response has a 4xx status code
func (o *CreateCSPMAzureAccountInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this create Cspm azure account internal server error response has a 5xx status code
func (o *CreateCSPMAzureAccountInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this create Cspm azure account internal server error response a status code equal to that given
func (o *CreateCSPMAzureAccountInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the create Cspm azure account internal server error response
