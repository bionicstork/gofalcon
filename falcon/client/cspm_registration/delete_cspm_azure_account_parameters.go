...
DeleteCSPMAzureAccountParams contains all the parameters to send to the API endpoint
	...
	for the delete CSPM azure account operation.
...
// WithDefaults hydrates default values in the delete CSPM azure account params (not the query body).
//
...
// SetDefaults hydrates default values in the delete CSPM azure account params (not the query body).
//
// All values with no default are reset to their zero value.
...
// SetRetainTenant adds the retainTenant to the delete CSPM azure account params
func (o *DeleteCSPMAzureAccountParams) SetRetainTenant(retainTenant *string) {
	o.RetainTenant = retainTenant
}

// WithTenantIds adds the tenantIds to the delete CSPM azure account params
func (o *DeleteCSPMAzureAccountParams) WithTenantIds(tenantIds []string) *DeleteCSPMAzureAccountParams {
	o.SetTenantIds(tenantIds)
	return o
}

// SetTenantIds adds the tenantIds to the delete CSPM azure account params
