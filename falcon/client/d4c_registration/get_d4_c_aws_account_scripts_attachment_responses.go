...
// IsSuccess returns true when this get d4 c Aws account scripts attachment o k response has a 2xx status code
func (o *GetD4CAWSAccountScriptsAttachmentOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get d4 c Aws account scripts attachment o k response has a 3xx status code
func (o *GetD4CAWSAccountScriptsAttachmentOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get d4 c Aws account scripts attachment o k response has a 4xx status code
func (o *GetD4CAWSAccountScriptsAttachmentOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get d4 c Aws account scripts attachment o k response has a 5xx status code
func (o *GetD4CAWSAccountScriptsAttachmentOK) IsServerError() bool {
	return false
}

// IsCode returns true when this get d4 c Aws account scripts attachment o k response a status code equal to that given
func (o *GetD4CAWSAccountScriptsAttachmentOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get d4 c Aws account scripts attachment o k response
...
// IsSuccess returns true when this get d4 c Aws account scripts attachment bad request response has a 2xx status code
func (o *GetD4CAWSAccountScriptsAttachmentBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get d4 c Aws account scripts attachment bad request response has a 3xx status code
func (o *GetD4CAWSAccountScriptsAttachmentBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get d4 c Aws account scripts attachment bad request response has a 4xx status code
func (o *GetD4CAWSAccountScriptsAttachmentBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this get d4 c Aws account scripts attachment bad request response has a 5xx status code
func (o *GetD4CAWSAccountScriptsAttachmentBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this get d4 c Aws account scripts attachment bad request response a status code equal to that given
func (o *GetD4CAWSAccountScriptsAttachmentBadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the get d4 c Aws account scripts attachment bad request response
...
// IsSuccess returns true when this get d4 c Aws account scripts attachment forbidden response has a 2xx status code
func (o *GetD4CAWSAccountScriptsAttachmentForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get d4 c Aws account scripts attachment forbidden response has a 3xx status code
func (o *GetD4CAWSAccountScriptsAttachmentForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get d4 c Aws account scripts attachment forbidden response has a 4xx status code
func (o *GetD4CAWSAccountScriptsAttachmentForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get d4 c Aws account scripts attachment forbidden response has a 5xx status code
func (o *GetD4CAWSAccountScriptsAttachmentForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get d4 c Aws account scripts attachment forbidden response a status code equal to that given
func (o *GetD4CAWSAccountScriptsAttachmentForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get d4 c Aws account scripts attachment forbidden response
...
// IsSuccess returns true when this get d4 c Aws account scripts attachment too many requests response has a 2xx status code
func (o *GetD4CAWSAccountScriptsAttachmentTooManyRequests) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get d4 c Aws account scripts attachment too many requests response has a 3xx status code
func (o *GetD4CAWSAccountScriptsAttachmentTooManyRequests) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get d4 c Aws account scripts attachment too many requests response has a 4xx status code
func (o *GetD4CAWSAccountScriptsAttachmentTooManyRequests) IsClientError() bool {
	return true
}

// IsServerError returns true when this get d4 c Aws account scripts attachment too many requests response has a 5xx status code
func (o *GetD4CAWSAccountScriptsAttachmentTooManyRequests) IsServerError() bool {
	return false
}

// IsCode returns true when this get d4 c Aws account scripts attachment too many requests response a status code equal to that given
func (o *GetD4CAWSAccountScriptsAttachmentTooManyRequests) IsCode(code int) bool {
	return code == 429
}

// Code gets the status code for the get d4 c Aws account scripts attachment too many requests response
...
// IsSuccess returns true when this get d4 c Aws account scripts attachment internal server error response has a 2xx status code
func (o *GetD4CAWSAccountScriptsAttachmentInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get d4 c Aws account scripts attachment internal server error response has a 3xx status code
func (o *GetD4CAWSAccountScriptsAttachmentInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get d4 c Aws account scripts attachment internal server error response has a 4xx status code
func (o *GetD4CAWSAccountScriptsAttachmentInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this get d4 c Aws account scripts attachment internal server error response has a 5xx status code
func (o *GetD4CAWSAccountScriptsAttachmentInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this get d4 c Aws account scripts attachment internal server error response a status code equal to that given
func (o *GetD4CAWSAccountScriptsAttachmentInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the get d4 c Aws account scripts attachment internal server error response
