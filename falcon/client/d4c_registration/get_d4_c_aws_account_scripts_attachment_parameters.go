...
GetD4CAWSAccountScriptsAttachmentParams contains all the parameters to send to the API endpoint
	...
	for the get d4 c AWS account scripts attachment operation.
...
// WithDefaults hydrates default values in the get d4 c AWS account scripts attachment params (not the query body).
//
...
// SetDefaults hydrates default values in the get d4 c AWS account scripts attachment params (not the query body).
//
// All values with no default are reset to their zero value.
...
// WithTimeout adds the timeout to the get d4 c AWS account scripts attachment params
...
// SetTimeout adds the timeout to the get d4 c AWS account scripts attachment params
func (o *GetD4CAWSAccountScriptsAttachmentParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get d4 c AWS account scripts attachment params
func (o *GetD4CAWSAccountScriptsAttachmentParams) WithContext(ctx context.Context) *GetD4CAWSAccountScriptsAttachmentParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get d4 c AWS account scripts attachment params
func (o *GetD4CAWSAccountScriptsAttachmentParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get d4 c AWS account scripts attachment params
...
// SetHTTPClient adds the HTTPClient to the get d4 c AWS account scripts attachment params
func (o *GetD4CAWSAccountScriptsAttachmentParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithIds adds the ids to the get d4 c AWS account scripts attachment params
func (o *GetD4CAWSAccountScriptsAttachmentParams) WithIds(ids []string) *GetD4CAWSAccountScriptsAttachmentParams {
	o.SetIds(ids)
	return o
}

// SetIds adds the ids to the get d4 c AWS account scripts attachment params
