...
/*
GetAssessmentV1 gets zero trust assessment data for one or more hosts by providing agent i ds a ID and a customer ID CID
*/
...
/*
GetAssessmentsByScoreV1 gets zero trust assessment data for one or more hosts by providing a customer ID CID and a range of scores
*/
...
/*
GetAuditV1 gets the zero trust assessment audit report for one customer ID CID
*/
