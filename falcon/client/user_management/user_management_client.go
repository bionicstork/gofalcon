...
/*
RetrieveUsersGETV1 gets info about users including their name UID and CID by providing user u UI ds
*/
...
/*
UserRolesActionV1 grants or revoke one or more role s to a user against a CID user UUID CID and role ID s can be provided in request payload available action s grant revoke
*/
