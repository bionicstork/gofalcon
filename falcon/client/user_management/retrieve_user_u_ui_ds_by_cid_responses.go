...
// IsSuccess returns true when this retrieve user u Ui ds by Cid o k response has a 2xx status code
func (o *RetrieveUserUUIDsByCIDOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this retrieve user u Ui ds by Cid o k response has a 3xx status code
func (o *RetrieveUserUUIDsByCIDOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this retrieve user u Ui ds by Cid o k response has a 4xx status code
func (o *RetrieveUserUUIDsByCIDOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this retrieve user u Ui ds by Cid o k response has a 5xx status code
func (o *RetrieveUserUUIDsByCIDOK) IsServerError() bool {
	return false
}

// IsCode returns true when this retrieve user u Ui ds by Cid o k response a status code equal to that given
func (o *RetrieveUserUUIDsByCIDOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the retrieve user u Ui ds by Cid o k response
...
// IsSuccess returns true when this retrieve user u Ui ds by Cid bad request response has a 2xx status code
func (o *RetrieveUserUUIDsByCIDBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this retrieve user u Ui ds by Cid bad request response has a 3xx status code
func (o *RetrieveUserUUIDsByCIDBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this retrieve user u Ui ds by Cid bad request response has a 4xx status code
func (o *RetrieveUserUUIDsByCIDBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this retrieve user u Ui ds by Cid bad request response has a 5xx status code
func (o *RetrieveUserUUIDsByCIDBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this retrieve user u Ui ds by Cid bad request response a status code equal to that given
func (o *RetrieveUserUUIDsByCIDBadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the retrieve user u Ui ds by Cid bad request response
...
// IsSuccess returns true when this retrieve user u Ui ds by Cid forbidden response has a 2xx status code
func (o *RetrieveUserUUIDsByCIDForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this retrieve user u Ui ds by Cid forbidden response has a 3xx status code
func (o *RetrieveUserUUIDsByCIDForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this retrieve user u Ui ds by Cid forbidden response has a 4xx status code
func (o *RetrieveUserUUIDsByCIDForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this retrieve user u Ui ds by Cid forbidden response has a 5xx status code
func (o *RetrieveUserUUIDsByCIDForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this retrieve user u Ui ds by Cid forbidden response a status code equal to that given
func (o *RetrieveUserUUIDsByCIDForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the retrieve user u Ui ds by Cid forbidden response
...
// IsSuccess returns true when this retrieve user u Ui ds by Cid too many requests response has a 2xx status code
func (o *RetrieveUserUUIDsByCIDTooManyRequests) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this retrieve user u Ui ds by Cid too many requests response has a 3xx status code
func (o *RetrieveUserUUIDsByCIDTooManyRequests) IsRedirect() bool {
	return false
}

// IsClientError returns true when this retrieve user u Ui ds by Cid too many requests response has a 4xx status code
func (o *RetrieveUserUUIDsByCIDTooManyRequests) IsClientError() bool {
	return true
}

// IsServerError returns true when this retrieve user u Ui ds by Cid too many requests response has a 5xx status code
func (o *RetrieveUserUUIDsByCIDTooManyRequests) IsServerError() bool {
	return false
}

// IsCode returns true when this retrieve user u Ui ds by Cid too many requests response a status code equal to that given
func (o *RetrieveUserUUIDsByCIDTooManyRequests) IsCode(code int) bool {
	return code == 429
}

// Code gets the status code for the retrieve user u Ui ds by Cid too many requests response
