...
// IsSuccess returns true when this update Aws account multi status response has a 2xx status code
func (o *UpdateAWSAccountMultiStatus) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this update Aws account multi status response has a 3xx status code
func (o *UpdateAWSAccountMultiStatus) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update Aws account multi status response has a 4xx status code
func (o *UpdateAWSAccountMultiStatus) IsClientError() bool {
	return false
}

// IsServerError returns true when this update Aws account multi status response has a 5xx status code
func (o *UpdateAWSAccountMultiStatus) IsServerError() bool {
	return false
}

// IsCode returns true when this update Aws account multi status response a status code equal to that given
func (o *UpdateAWSAccountMultiStatus) IsCode(code int) bool {
	return code == 207
}

// Code gets the status code for the update Aws account multi status response
...
// IsSuccess returns true when this update Aws account too many requests response has a 2xx status code
func (o *UpdateAWSAccountTooManyRequests) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update Aws account too many requests response has a 3xx status code
func (o *UpdateAWSAccountTooManyRequests) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update Aws account too many requests response has a 4xx status code
func (o *UpdateAWSAccountTooManyRequests) IsClientError() bool {
	return true
}

// IsServerError returns true when this update Aws account too many requests response has a 5xx status code
func (o *UpdateAWSAccountTooManyRequests) IsServerError() bool {
	return false
}

// IsCode returns true when this update Aws account too many requests response a status code equal to that given
func (o *UpdateAWSAccountTooManyRequests) IsCode(code int) bool {
	return code == 429
}

// Code gets the status code for the update Aws account too many requests response
