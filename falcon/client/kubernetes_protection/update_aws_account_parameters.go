...
// WithIds adds the ids to the update AWS account params
func (o *UpdateAWSAccountParams) WithIds(ids []string) *UpdateAWSAccountParams {
	o.SetIds(ids)
	return o
}

// SetIds adds the ids to the update AWS account params
func (o *UpdateAWSAccountParams) SetIds(ids []string) {
	o.Ids = ids
}

// WithRegion adds the region to the update AWS account params
func (o *UpdateAWSAccountParams) WithRegion(region *string) *UpdateAWSAccountParams {
	o.SetRegion(region)
	return o
}

// SetRegion adds the region to the update AWS account params
