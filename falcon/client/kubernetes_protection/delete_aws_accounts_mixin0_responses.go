...
// IsRedirect returns true when this delete Aws accounts mixin0 o k response has a 3xx status code
func (o *DeleteAWSAccountsMixin0OK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete Aws accounts mixin0 o k response has a 4xx status code
func (o *DeleteAWSAccountsMixin0OK) IsClientError() bool {
	return false
}

// IsServerError returns true when this delete Aws accounts mixin0 o k response has a 5xx status code
func (o *DeleteAWSAccountsMixin0OK) IsServerError() bool {
	return false
}

// IsCode returns true when this delete Aws accounts mixin0 o k response a status code equal to that given
func (o *DeleteAWSAccountsMixin0OK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the delete Aws accounts mixin0 o k response
...
// IsRedirect returns true when this delete Aws accounts mixin0 multi status response has a 3xx status code
func (o *DeleteAWSAccountsMixin0MultiStatus) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete Aws accounts mixin0 multi status response has a 4xx status code
func (o *DeleteAWSAccountsMixin0MultiStatus) IsClientError() bool {
	return false
}

// IsServerError returns true when this delete Aws accounts mixin0 multi status response has a 5xx status code
func (o *DeleteAWSAccountsMixin0MultiStatus) IsServerError() bool {
	return false
}

// IsCode returns true when this delete Aws accounts mixin0 multi status response a status code equal to that given
func (o *DeleteAWSAccountsMixin0MultiStatus) IsCode(code int) bool {
	return code == 207
}

// Code gets the status code for the delete Aws accounts mixin0 multi status response
...
// IsRedirect returns true when this delete Aws accounts mixin0 bad request response has a 3xx status code
func (o *DeleteAWSAccountsMixin0BadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete Aws accounts mixin0 bad request response has a 4xx status code
func (o *DeleteAWSAccountsMixin0BadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete Aws accounts mixin0 bad request response has a 5xx status code
func (o *DeleteAWSAccountsMixin0BadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this delete Aws accounts mixin0 bad request response a status code equal to that given
func (o *DeleteAWSAccountsMixin0BadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the delete Aws accounts mixin0 bad request response
...
// IsSuccess returns true when this delete Aws accounts mixin0 forbidden response has a 2xx status code
func (o *DeleteAWSAccountsMixin0Forbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete Aws accounts mixin0 forbidden response has a 3xx status code
func (o *DeleteAWSAccountsMixin0Forbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete Aws accounts mixin0 forbidden response has a 4xx status code
func (o *DeleteAWSAccountsMixin0Forbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete Aws accounts mixin0 forbidden response has a 5xx status code
func (o *DeleteAWSAccountsMixin0Forbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete Aws accounts mixin0 forbidden response a status code equal to that given
func (o *DeleteAWSAccountsMixin0Forbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete Aws accounts mixin0 forbidden response
...
// IsSuccess returns true when this delete Aws accounts mixin0 too many requests response has a 2xx status code
func (o *DeleteAWSAccountsMixin0TooManyRequests) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete Aws accounts mixin0 too many requests response has a 3xx status code
func (o *DeleteAWSAccountsMixin0TooManyRequests) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete Aws accounts mixin0 too many requests response has a 4xx status code
func (o *DeleteAWSAccountsMixin0TooManyRequests) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete Aws accounts mixin0 too many requests response has a 5xx status code
func (o *DeleteAWSAccountsMixin0TooManyRequests) IsServerError() bool {
	return false
}

// IsCode returns true when this delete Aws accounts mixin0 too many requests response a status code equal to that given
func (o *DeleteAWSAccountsMixin0TooManyRequests) IsCode(code int) bool {
	return code == 429
}

// Code gets the status code for the delete Aws accounts mixin0 too many requests response
...
// IsRedirect returns true when this delete Aws accounts mixin0 internal server error response has a 3xx status code
func (o *DeleteAWSAccountsMixin0InternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete Aws accounts mixin0 internal server error response has a 4xx status code
func (o *DeleteAWSAccountsMixin0InternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this delete Aws accounts mixin0 internal server error response has a 5xx status code
func (o *DeleteAWSAccountsMixin0InternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this delete Aws accounts mixin0 internal server error response a status code equal to that given
func (o *DeleteAWSAccountsMixin0InternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the delete Aws accounts mixin0 internal server error response
