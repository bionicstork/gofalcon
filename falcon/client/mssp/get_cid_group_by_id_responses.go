...
// IsSuccess returns true when this get Cid group by Id o k response has a 2xx status code
func (o *GetCIDGroupByIDOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get Cid group by Id o k response has a 3xx status code
func (o *GetCIDGroupByIDOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cid group by Id o k response has a 4xx status code
func (o *GetCIDGroupByIDOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get Cid group by Id o k response has a 5xx status code
func (o *GetCIDGroupByIDOK) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cid group by Id o k response a status code equal to that given
func (o *GetCIDGroupByIDOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get Cid group by Id o k response
...
// IsSuccess returns true when this get Cid group by Id multi status response has a 2xx status code
func (o *GetCIDGroupByIDMultiStatus) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get Cid group by Id multi status response has a 3xx status code
func (o *GetCIDGroupByIDMultiStatus) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cid group by Id multi status response has a 4xx status code
func (o *GetCIDGroupByIDMultiStatus) IsClientError() bool {
	return false
}

// IsServerError returns true when this get Cid group by Id multi status response has a 5xx status code
func (o *GetCIDGroupByIDMultiStatus) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cid group by Id multi status response a status code equal to that given
func (o *GetCIDGroupByIDMultiStatus) IsCode(code int) bool {
	return code == 207
}

// Code gets the status code for the get Cid group by Id multi status response
...
// IsSuccess returns true when this get Cid group by Id bad request response has a 2xx status code
func (o *GetCIDGroupByIDBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Cid group by Id bad request response has a 3xx status code
func (o *GetCIDGroupByIDBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cid group by Id bad request response has a 4xx status code
func (o *GetCIDGroupByIDBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this get Cid group by Id bad request response has a 5xx status code
func (o *GetCIDGroupByIDBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cid group by Id bad request response a status code equal to that given
func (o *GetCIDGroupByIDBadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the get Cid group by Id bad request response
...
// IsSuccess returns true when this get Cid group by Id forbidden response has a 2xx status code
func (o *GetCIDGroupByIDForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Cid group by Id forbidden response has a 3xx status code
func (o *GetCIDGroupByIDForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cid group by Id forbidden response has a 4xx status code
func (o *GetCIDGroupByIDForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get Cid group by Id forbidden response has a 5xx status code
func (o *GetCIDGroupByIDForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cid group by Id forbidden response a status code equal to that given
func (o *GetCIDGroupByIDForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get Cid group by Id forbidden response
...
// IsSuccess returns true when this get Cid group by Id too many requests response has a 2xx status code
func (o *GetCIDGroupByIDTooManyRequests) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Cid group by Id too many requests response has a 3xx status code
func (o *GetCIDGroupByIDTooManyRequests) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cid group by Id too many requests response has a 4xx status code
func (o *GetCIDGroupByIDTooManyRequests) IsClientError() bool {
	return true
}

// IsServerError returns true when this get Cid group by Id too many requests response has a 5xx status code
func (o *GetCIDGroupByIDTooManyRequests) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cid group by Id too many requests response a status code equal to that given
func (o *GetCIDGroupByIDTooManyRequests) IsCode(code int) bool {
	return code == 429
}

// Code gets the status code for the get Cid group by Id too many requests response
