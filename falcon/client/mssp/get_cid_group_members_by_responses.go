...
// IsSuccess returns true when this get Cid group members by o k response has a 2xx status code
func (o *GetCIDGroupMembersByOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get Cid group members by o k response has a 3xx status code
func (o *GetCIDGroupMembersByOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cid group members by o k response has a 4xx status code
func (o *GetCIDGroupMembersByOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get Cid group members by o k response has a 5xx status code
func (o *GetCIDGroupMembersByOK) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cid group members by o k response a status code equal to that given
func (o *GetCIDGroupMembersByOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get Cid group members by o k response
...
// IsSuccess returns true when this get Cid group members by multi status response has a 2xx status code
func (o *GetCIDGroupMembersByMultiStatus) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get Cid group members by multi status response has a 3xx status code
func (o *GetCIDGroupMembersByMultiStatus) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cid group members by multi status response has a 4xx status code
func (o *GetCIDGroupMembersByMultiStatus) IsClientError() bool {
	return false
}

// IsServerError returns true when this get Cid group members by multi status response has a 5xx status code
func (o *GetCIDGroupMembersByMultiStatus) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cid group members by multi status response a status code equal to that given
func (o *GetCIDGroupMembersByMultiStatus) IsCode(code int) bool {
	return code == 207
}

// Code gets the status code for the get Cid group members by multi status response
...
// IsSuccess returns true when this get Cid group members by bad request response has a 2xx status code
func (o *GetCIDGroupMembersByBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Cid group members by bad request response has a 3xx status code
func (o *GetCIDGroupMembersByBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cid group members by bad request response has a 4xx status code
func (o *GetCIDGroupMembersByBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this get Cid group members by bad request response has a 5xx status code
func (o *GetCIDGroupMembersByBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cid group members by bad request response a status code equal to that given
func (o *GetCIDGroupMembersByBadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the get Cid group members by bad request response
...
// IsSuccess returns true when this get Cid group members by forbidden response has a 2xx status code
func (o *GetCIDGroupMembersByForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Cid group members by forbidden response has a 3xx status code
func (o *GetCIDGroupMembersByForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cid group members by forbidden response has a 4xx status code
func (o *GetCIDGroupMembersByForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get Cid group members by forbidden response has a 5xx status code
func (o *GetCIDGroupMembersByForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cid group members by forbidden response a status code equal to that given
func (o *GetCIDGroupMembersByForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get Cid group members by forbidden response
...
// IsSuccess returns true when this get Cid group members by too many requests response has a 2xx status code
func (o *GetCIDGroupMembersByTooManyRequests) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Cid group members by too many requests response has a 3xx status code
func (o *GetCIDGroupMembersByTooManyRequests) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cid group members by too many requests response has a 4xx status code
func (o *GetCIDGroupMembersByTooManyRequests) IsClientError() bool {
	return true
}

// IsServerError returns true when this get Cid group members by too many requests response has a 5xx status code
func (o *GetCIDGroupMembersByTooManyRequests) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cid group members by too many requests response a status code equal to that given
func (o *GetCIDGroupMembersByTooManyRequests) IsCode(code int) bool {
	return code == 429
}

// Code gets the status code for the get Cid group members by too many requests response
