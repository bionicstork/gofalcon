...
// IsSuccess returns true when this delete Cid group members o k response has a 2xx status code
func (o *DeleteCIDGroupMembersOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this delete Cid group members o k response has a 3xx status code
func (o *DeleteCIDGroupMembersOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete Cid group members o k response has a 4xx status code
func (o *DeleteCIDGroupMembersOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this delete Cid group members o k response has a 5xx status code
func (o *DeleteCIDGroupMembersOK) IsServerError() bool {
	return false
}

// IsCode returns true when this delete Cid group members o k response a status code equal to that given
func (o *DeleteCIDGroupMembersOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the delete Cid group members o k response
...
// IsSuccess returns true when this delete Cid group members multi status response has a 2xx status code
func (o *DeleteCIDGroupMembersMultiStatus) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this delete Cid group members multi status response has a 3xx status code
func (o *DeleteCIDGroupMembersMultiStatus) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete Cid group members multi status response has a 4xx status code
func (o *DeleteCIDGroupMembersMultiStatus) IsClientError() bool {
	return false
}

// IsServerError returns true when this delete Cid group members multi status response has a 5xx status code
func (o *DeleteCIDGroupMembersMultiStatus) IsServerError() bool {
	return false
}

// IsCode returns true when this delete Cid group members multi status response a status code equal to that given
func (o *DeleteCIDGroupMembersMultiStatus) IsCode(code int) bool {
	return code == 207
}

// Code gets the status code for the delete Cid group members multi status response
...
// IsSuccess returns true when this delete Cid group members bad request response has a 2xx status code
func (o *DeleteCIDGroupMembersBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete Cid group members bad request response has a 3xx status code
func (o *DeleteCIDGroupMembersBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete Cid group members bad request response has a 4xx status code
func (o *DeleteCIDGroupMembersBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete Cid group members bad request response has a 5xx status code
func (o *DeleteCIDGroupMembersBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this delete Cid group members bad request response a status code equal to that given
func (o *DeleteCIDGroupMembersBadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the delete Cid group members bad request response
...
// IsSuccess returns true when this delete Cid group members forbidden response has a 2xx status code
func (o *DeleteCIDGroupMembersForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete Cid group members forbidden response has a 3xx status code
func (o *DeleteCIDGroupMembersForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete Cid group members forbidden response has a 4xx status code
func (o *DeleteCIDGroupMembersForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete Cid group members forbidden response has a 5xx status code
func (o *DeleteCIDGroupMembersForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete Cid group members forbidden response a status code equal to that given
func (o *DeleteCIDGroupMembersForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete Cid group members forbidden response
...
// IsSuccess returns true when this delete Cid group members too many requests response has a 2xx status code
func (o *DeleteCIDGroupMembersTooManyRequests) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete Cid group members too many requests response has a 3xx status code
func (o *DeleteCIDGroupMembersTooManyRequests) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete Cid group members too many requests response has a 4xx status code
func (o *DeleteCIDGroupMembersTooManyRequests) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete Cid group members too many requests response has a 5xx status code
func (o *DeleteCIDGroupMembersTooManyRequests) IsServerError() bool {
	return false
}

// IsCode returns true when this delete Cid group members too many requests response a status code equal to that given
func (o *DeleteCIDGroupMembersTooManyRequests) IsCode(code int) bool {
	return code == 429
}

// Code gets the status code for the delete Cid group members too many requests response
