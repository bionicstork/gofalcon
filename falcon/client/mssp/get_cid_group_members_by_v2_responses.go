...
// IsSuccess returns true when this get Cid group members by v2 o k response has a 2xx status code
func (o *GetCIDGroupMembersByV2OK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get Cid group members by v2 o k response has a 3xx status code
func (o *GetCIDGroupMembersByV2OK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cid group members by v2 o k response has a 4xx status code
func (o *GetCIDGroupMembersByV2OK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get Cid group members by v2 o k response has a 5xx status code
func (o *GetCIDGroupMembersByV2OK) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cid group members by v2 o k response a status code equal to that given
func (o *GetCIDGroupMembersByV2OK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get Cid group members by v2 o k response
...
// IsSuccess returns true when this get Cid group members by v2 multi status response has a 2xx status code
func (o *GetCIDGroupMembersByV2MultiStatus) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get Cid group members by v2 multi status response has a 3xx status code
func (o *GetCIDGroupMembersByV2MultiStatus) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cid group members by v2 multi status response has a 4xx status code
func (o *GetCIDGroupMembersByV2MultiStatus) IsClientError() bool {
	return false
}

// IsServerError returns true when this get Cid group members by v2 multi status response has a 5xx status code
func (o *GetCIDGroupMembersByV2MultiStatus) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cid group members by v2 multi status response a status code equal to that given
func (o *GetCIDGroupMembersByV2MultiStatus) IsCode(code int) bool {
	return code == 207
}

// Code gets the status code for the get Cid group members by v2 multi status response
...
// IsSuccess returns true when this get Cid group members by v2 bad request response has a 2xx status code
func (o *GetCIDGroupMembersByV2BadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Cid group members by v2 bad request response has a 3xx status code
func (o *GetCIDGroupMembersByV2BadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cid group members by v2 bad request response has a 4xx status code
func (o *GetCIDGroupMembersByV2BadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this get Cid group members by v2 bad request response has a 5xx status code
func (o *GetCIDGroupMembersByV2BadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cid group members by v2 bad request response a status code equal to that given
func (o *GetCIDGroupMembersByV2BadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the get Cid group members by v2 bad request response
...
// IsSuccess returns true when this get Cid group members by v2 forbidden response has a 2xx status code
func (o *GetCIDGroupMembersByV2Forbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Cid group members by v2 forbidden response has a 3xx status code
func (o *GetCIDGroupMembersByV2Forbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cid group members by v2 forbidden response has a 4xx status code
func (o *GetCIDGroupMembersByV2Forbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get Cid group members by v2 forbidden response has a 5xx status code
func (o *GetCIDGroupMembersByV2Forbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cid group members by v2 forbidden response a status code equal to that given
func (o *GetCIDGroupMembersByV2Forbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get Cid group members by v2 forbidden response
...
// IsSuccess returns true when this get Cid group members by v2 too many requests response has a 2xx status code
func (o *GetCIDGroupMembersByV2TooManyRequests) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get Cid group members by v2 too many requests response has a 3xx status code
func (o *GetCIDGroupMembersByV2TooManyRequests) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Cid group members by v2 too many requests response has a 4xx status code
func (o *GetCIDGroupMembersByV2TooManyRequests) IsClientError() bool {
	return true
}

// IsServerError returns true when this get Cid group members by v2 too many requests response has a 5xx status code
func (o *GetCIDGroupMembersByV2TooManyRequests) IsServerError() bool {
	return false
}

// IsCode returns true when this get Cid group members by v2 too many requests response a status code equal to that given
func (o *GetCIDGroupMembersByV2TooManyRequests) IsCode(code int) bool {
	return code == 429
}

// Code gets the status code for the get Cid group members by v2 too many requests response
