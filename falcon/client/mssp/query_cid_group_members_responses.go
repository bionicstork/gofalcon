...
// IsSuccess returns true when this query Cid group members o k response has a 2xx status code
func (o *QueryCIDGroupMembersOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this query Cid group members o k response has a 3xx status code
func (o *QueryCIDGroupMembersOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this query Cid group members o k response has a 4xx status code
func (o *QueryCIDGroupMembersOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this query Cid group members o k response has a 5xx status code
func (o *QueryCIDGroupMembersOK) IsServerError() bool {
	return false
}

// IsCode returns true when this query Cid group members o k response a status code equal to that given
func (o *QueryCIDGroupMembersOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the query Cid group members o k response
...
// IsSuccess returns true when this query Cid group members forbidden response has a 2xx status code
func (o *QueryCIDGroupMembersForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this query Cid group members forbidden response has a 3xx status code
func (o *QueryCIDGroupMembersForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this query Cid group members forbidden response has a 4xx status code
func (o *QueryCIDGroupMembersForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this query Cid group members forbidden response has a 5xx status code
func (o *QueryCIDGroupMembersForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this query Cid group members forbidden response a status code equal to that given
func (o *QueryCIDGroupMembersForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the query Cid group members forbidden response
...
// IsSuccess returns true when this query Cid group members too many requests response has a 2xx status code
func (o *QueryCIDGroupMembersTooManyRequests) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this query Cid group members too many requests response has a 3xx status code
func (o *QueryCIDGroupMembersTooManyRequests) IsRedirect() bool {
	return false
}

// IsClientError returns true when this query Cid group members too many requests response has a 4xx status code
func (o *QueryCIDGroupMembersTooManyRequests) IsClientError() bool {
	return true
}

// IsServerError returns true when this query Cid group members too many requests response has a 5xx status code
func (o *QueryCIDGroupMembersTooManyRequests) IsServerError() bool {
	return false
}

// IsCode returns true when this query Cid group members too many requests response a status code equal to that given
func (o *QueryCIDGroupMembersTooManyRequests) IsCode(code int) bool {
	return code == 429
}

// Code gets the status code for the query Cid group members too many requests response
