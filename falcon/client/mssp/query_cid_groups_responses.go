...
// IsSuccess returns true when this query Cid groups o k response has a 2xx status code
func (o *QueryCIDGroupsOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this query Cid groups o k response has a 3xx status code
func (o *QueryCIDGroupsOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this query Cid groups o k response has a 4xx status code
func (o *QueryCIDGroupsOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this query Cid groups o k response has a 5xx status code
func (o *QueryCIDGroupsOK) IsServerError() bool {
	return false
}

// IsCode returns true when this query Cid groups o k response a status code equal to that given
func (o *QueryCIDGroupsOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the query Cid groups o k response
...
// IsSuccess returns true when this query Cid groups forbidden response has a 2xx status code
func (o *QueryCIDGroupsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this query Cid groups forbidden response has a 3xx status code
func (o *QueryCIDGroupsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this query Cid groups forbidden response has a 4xx status code
func (o *QueryCIDGroupsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this query Cid groups forbidden response has a 5xx status code
func (o *QueryCIDGroupsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this query Cid groups forbidden response a status code equal to that given
func (o *QueryCIDGroupsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the query Cid groups forbidden response
...
// IsSuccess returns true when this query Cid groups too many requests response has a 2xx status code
func (o *QueryCIDGroupsTooManyRequests) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this query Cid groups too many requests response has a 3xx status code
func (o *QueryCIDGroupsTooManyRequests) IsRedirect() bool {
	return false
}

// IsClientError returns true when this query Cid groups too many requests response has a 4xx status code
func (o *QueryCIDGroupsTooManyRequests) IsClientError() bool {
	return true
}

// IsServerError returns true when this query Cid groups too many requests response has a 5xx status code
func (o *QueryCIDGroupsTooManyRequests) IsServerError() bool {
	return false
}

// IsCode returns true when this query Cid groups too many requests response a status code equal to that given
func (o *QueryCIDGroupsTooManyRequests) IsCode(code int) bool {
	return code == 429
}

// Code gets the status code for the query Cid groups too many requests response
