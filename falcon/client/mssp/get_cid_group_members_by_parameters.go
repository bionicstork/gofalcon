...
GetCIDGroupMembersByParams contains all the parameters to send to the API endpoint
	...
	for the get CID group members by operation.
...
// WithDefaults hydrates default values in the get CID group members by params (not the query body).
//
...
// SetDefaults hydrates default values in the get CID group members by params (not the query body).
//
// All values with no default are reset to their zero value.
...
// WithTimeout adds the timeout to the get CID group members by params
func (o *GetCIDGroupMembersByParams) WithTimeout(timeout time.Duration) *GetCIDGroupMembersByParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get CID group members by params
func (o *GetCIDGroupMembersByParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get CID group members by params
func (o *GetCIDGroupMembersByParams) WithContext(ctx context.Context) *GetCIDGroupMembersByParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get CID group members by params
func (o *GetCIDGroupMembersByParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get CID group members by params
func (o *GetCIDGroupMembersByParams) WithHTTPClient(client *http.Client) *GetCIDGroupMembersByParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the get CID group members by params
func (o *GetCIDGroupMembersByParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithCIDGroupIds adds the cIDGroupIds to the get CID group members by params
...
// SetCIDGroupIds adds the cidGroupIds to the get CID group members by params
