...
UpdateCIDGroupsParams contains all the parameters to send to the API endpoint
	...
	for the update CID groups operation.
...
// WithDefaults hydrates default values in the update CID groups params (not the query body).
//
...
// SetDefaults hydrates default values in the update CID groups params (not the query body).
//
// All values with no default are reset to their zero value.
