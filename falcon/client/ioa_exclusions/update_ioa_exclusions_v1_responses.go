...
// IsSuccess returns true when this update Ioa exclusions v1 o k response has a 2xx status code
func (o *UpdateIOAExclusionsV1OK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this update Ioa exclusions v1 o k response has a 3xx status code
func (o *UpdateIOAExclusionsV1OK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update Ioa exclusions v1 o k response has a 4xx status code
func (o *UpdateIOAExclusionsV1OK) IsClientError() bool {
	return false
}

// IsServerError returns true when this update Ioa exclusions v1 o k response has a 5xx status code
func (o *UpdateIOAExclusionsV1OK) IsServerError() bool {
	return false
}

// IsCode returns true when this update Ioa exclusions v1 o k response a status code equal to that given
func (o *UpdateIOAExclusionsV1OK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the update Ioa exclusions v1 o k response
...
// IsSuccess returns true when this update Ioa exclusions v1 bad request response has a 2xx status code
func (o *UpdateIOAExclusionsV1BadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update Ioa exclusions v1 bad request response has a 3xx status code
func (o *UpdateIOAExclusionsV1BadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update Ioa exclusions v1 bad request response has a 4xx status code
func (o *UpdateIOAExclusionsV1BadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this update Ioa exclusions v1 bad request response has a 5xx status code
func (o *UpdateIOAExclusionsV1BadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this update Ioa exclusions v1 bad request response a status code equal to that given
func (o *UpdateIOAExclusionsV1BadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the update Ioa exclusions v1 bad request response
...
// IsSuccess returns true when this update Ioa exclusions v1 forbidden response has a 2xx status code
func (o *UpdateIOAExclusionsV1Forbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update Ioa exclusions v1 forbidden response has a 3xx status code
func (o *UpdateIOAExclusionsV1Forbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update Ioa exclusions v1 forbidden response has a 4xx status code
func (o *UpdateIOAExclusionsV1Forbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update Ioa exclusions v1 forbidden response has a 5xx status code
func (o *UpdateIOAExclusionsV1Forbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update Ioa exclusions v1 forbidden response a status code equal to that given
func (o *UpdateIOAExclusionsV1Forbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update Ioa exclusions v1 forbidden response
...
// IsSuccess returns true when this update Ioa exclusions v1 too many requests response has a 2xx status code
func (o *UpdateIOAExclusionsV1TooManyRequests) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update Ioa exclusions v1 too many requests response has a 3xx status code
func (o *UpdateIOAExclusionsV1TooManyRequests) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update Ioa exclusions v1 too many requests response has a 4xx status code
func (o *UpdateIOAExclusionsV1TooManyRequests) IsClientError() bool {
	return true
}

// IsServerError returns true when this update Ioa exclusions v1 too many requests response has a 5xx status code
func (o *UpdateIOAExclusionsV1TooManyRequests) IsServerError() bool {
	return false
}

// IsCode returns true when this update Ioa exclusions v1 too many requests response a status code equal to that given
func (o *UpdateIOAExclusionsV1TooManyRequests) IsCode(code int) bool {
	return code == 429
}

// Code gets the status code for the update Ioa exclusions v1 too many requests response
...
// IsSuccess returns true when this update Ioa exclusions v1 internal server error response has a 2xx status code
func (o *UpdateIOAExclusionsV1InternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update Ioa exclusions v1 internal server error response has a 3xx status code
func (o *UpdateIOAExclusionsV1InternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update Ioa exclusions v1 internal server error response has a 4xx status code
func (o *UpdateIOAExclusionsV1InternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this update Ioa exclusions v1 internal server error response has a 5xx status code
func (o *UpdateIOAExclusionsV1InternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this update Ioa exclusions v1 internal server error response a status code equal to that given
func (o *UpdateIOAExclusionsV1InternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the update Ioa exclusions v1 internal server error response
